...
static const struct FrontierBrainMon sFrontierBrainsMons[][2][FRONTIER_PARTY_SIZE] =
{
    [FRONTIER_FACILITY_TOWER] =
    {
        // Silver Symbol.
        {
            ...
            {
                .species = SPECIES_NORMAL_BYAKUREN,
        ...
        // Gold Symbol.
        {
            ...
            {
                .species = SPECIES_PLACEHOLD_KOTOHIME,
                .heldItem = ITEM_BRIGHT_POWDER,
                .fixedIV = MAX_PER_STAT_IVS,
                .nature = NATURE_MODEST,
                .evs = {252, 0, 252, 6, 0, 0},
    ...
    [FRONTIER_FACILITY_DOME] =
    {
        // Silver Symbol.
        {
            ...
            },
            {
                ...
                .moves = {MOVE_EARTHQUAKE, MOVE_BRICK_BREAK, MOVE_HEART_BREAK, MOVE_AERIAL_ACE},
            },
            {
        ...
        // Gold Symbol.
        {
            ...
            {
                .species = SPECIES_NORMAL_KOTOHIME,
                .heldItem = ITEM_CHESTO_BERRY,
                .fixedIV = MAX_PER_STAT_IVS,
                .nature = NATURE_MODEST,
                .evs = {252, 0, 252, 6, 0, 0},
    ...
    [FRONTIER_FACILITY_PALACE] =
    {
        // Silver Symbol.
        {
            ...
            },
            {
                ...
                .moves = {MOVE_ICE_BEAM, MOVE_SCULPTURE, MOVE_CONFUSE_RAY, MOVE_PROTECT},
            },
        },
        // Gold Symbol.
        {
            {
                .species = SPECIES_HELPER_LILY_WHITE,
                .heldItem = ITEM_WHITE_HERB,
                .fixedIV = MAX_PER_STAT_IVS,
                .nature = NATURE_HASTY,
                .evs = {6, 252, 252, 0, 0, 0},
    ...
    [FRONTIER_FACILITY_ARENA] =
    {
        // Silver Symbol.
        {
            ...
            },
            {
                ...
                .moves = {MOVE_BODY_SLAM, MOVE_CONFUSE_RAY, MOVE_MANA_BURST, MOVE_FEINT_ATTACK},
            },
            {
        ...
        {
            {
                ...
                .nature = NATURE_CALM,
                .evs = {252, 0, 0, 0, 252, 6},
                .moves = {MOVE_DOUBLE_EDGE, MOVE_CONFUSE_RAY, MOVE_REST, MOVE_MANA_BURST},
            },
            {
    ...
    [FRONTIER_FACILITY_FACTORY] =
    {
        ...
        // What is interesting, this team is actually the one Steven uses in the multi tag battle alongside the player.
        {
            ...
            },
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {0, 252, 0, 0, 252, 6},
                .moves = {MOVE_THUNDERBOLT, MOVE_PROTECT, MOVE_SOLAR_BEAM, MOVE_HEART_BREAK},
            },
        },
        {
            {
        ...
        {
            {
                ...
                .nature = NATURE_BOLD,
                .evs = {252, 0, 0, 0, 252, 6},
                .moves = {MOVE_SWAGGER, MOVE_CRUNCH, MOVE_POISON_BOMB, MOVE_GIGA_DRAIN},
            },
            {
