...
//gui font
static const u8 sFontColor_Black[3] = {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_LIGHT_GRAY, TEXT_DYNAMIC_COLOR_1};
static const u8 sFontColor_White[3] = {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_LIGHT_GRAY};
//search window font
...
static u16 DexNavGenerateHeldItem(enum Species species, u8 searchLevel)
{
    ...
    enum Item itemCommon = gSpeciesInfo[species].itemCommon;
    enum Item itemRare = gSpeciesInfo[species].itemRare;
    ...
    if (itemCommon == ITEM_NONE && itemRare == ITEM_NONE)
        return ITEM_NONE;
...
static void Task_DexNavMain(u8 taskId)
{
    ...
    enum Species species, registeredSpecies;
    ...
    else if (JOY_NEW(R_BUTTON))
    {
        ...
        registeredSpecies = VarGet(DN_VAR_SPECIES);
