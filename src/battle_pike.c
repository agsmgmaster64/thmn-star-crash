...
{
    {
        ...
        .levelDelta = 4,
        .moves = {MOVE_TOXIC, MOVE_GLARE, MOVE_BODY_SLAM, MOVE_POISON_BOMB}
    },
    {
...
static const struct PikeWildMon sLvl50_Mons2[] =
{
    ...
    {
        .species = SPECIES_NORMAL_WRIGGLE,
        .levelDelta = 5,
...
static const struct PikeWildMon sLvl50_Mons3[] =
{
    ...
    },
    {
        ...
        .levelDelta = 5,
        .moves = {MOVE_SPORE, MOVE_STUN_SPORE, MOVE_POISON_POWDER, MOVE_MULTI_PULSE}
    }
};
...
{
    {
        .species = SPECIES_NORMAL_STAR,
        .levelDelta = 4,
        .moves = {MOVE_TOXIC, MOVE_GLARE, MOVE_POISON_FANG, MOVE_POISON_BOMB}
    },
    {
        .species = SPECIES_PLACEHOLD_TOYOHIME,
        .levelDelta = 4,
...
// End hexorb Branch
{
    ...
    case STATUS1_FREEZE:
    case STATUS1_FROSTBITE:
        if (ability == ABILITY_FIRE_VEIL || ability == ABILITY_FLAME_BODY)
            ret = TRUE;
        break;
    case STATUS1_BURN:
...
static bool8 DoesTypePreventStatus(u16 species, u32 status)
{
    ...
    {
    case STATUS1_TOXIC_POISON:
        if (GetSpeciesType(species, 0) == TYPE_STEEL || GetSpeciesType(species, 0) == TYPE_MIASMA
            || GetSpeciesType(species, 1) == TYPE_STEEL || GetSpeciesType(species, 1) == TYPE_MIASMA)
            ret = TRUE;
        break;
    case STATUS1_FREEZE:
    case STATUS1_FROSTBITE:
...
static u8 SpeciesToPikeMonId(u16 species)
{
    ...
    if (species == SPECIES_NORMAL_STAR)
        ret = 0;
    else if (species == SPECIES_PLACEHOLD_TOYOHIME)
        ret = 1;
    else
        ret = 2;
