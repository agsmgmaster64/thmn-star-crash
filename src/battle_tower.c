...
const struct FacilityClass gTowerMaleFacilityClasses[FACILITY_CLASSES_MALE] =
{
    ...
    {FACILITY_CLASS_BUG_CATCHER, OBJ_EVENT_GFX_BUG_CATCHER_2},
    {FACILITY_CLASS_HIKER, OBJ_EVENT_GFX_HIKER_2},
};
...
const struct FacilityClass gTowerFemaleFacilityClasses[FACILITY_CLASSES_FEMALE] =
{
    ...
    {FACILITY_CLASS_PSYCHIC_F, OBJ_EVENT_GFX_PSYCHIC_F},
    {FACILITY_CLASS_SCHOOL_KID_F, OBJ_EVENT_GFX_SCHOOL_KID_F},
    ...
    {FACILITY_CLASS_LASS, OBJ_EVENT_GFX_LASS_2},
};
