...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_STOPLEARNINGMOVE]                     = COMPOUND_STRING("{PAUSE 32}Do you want to continue on having {B_BUFF1} learn {B_BUFF2}?"),
    ...
    [STRINGID_HITXTIMES]                            = COMPOUND_STRING("The Puppet was hit {B_BUFF1} time(s)!"), //SV has dynamic plural here
    ...
    [STRINGID_PKMNCUTSATTACKWITH]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1} fell!"), // Required to distinguish Intimidate
    [STRINGID_PKMNPREVENTSSTATLOSSWITH]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s stats were not lowered!"),
    [STRINGID_PKMNPREVENTSSTATGAINWITH]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s stats were not raised!"),
    ...
    [STRINGID_FAINTINTHREE]                         = COMPOUND_STRING("All Puppets that heard the song will faint in three turns!"),
    ...
    [STRINGID_TRAINERBLOCKEDBALL]                   = COMPOUND_STRING("The Trainer blocked your Toho Orb!"),
    [STRINGID_DONTBEATHIEF]                         = COMPOUND_STRING("Don't be a thief!"),
    [STRINGID_ITDODGEDBALL]                         = COMPOUND_STRING("It dodged your thrown Toho Orb! This Puppet can't be caught!"),
    [STRINGID_PKMNBROKEFREE]                        = COMPOUND_STRING("Oh no! The Puppet broke free!"),
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_CAUGHT_BGM}\p"),
    [STRINGID_GOTCHAPKMNCAUGHTWALLY]                = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_CAUGHT_BGM}{PAUSE 127}"),
    [STRINGID_GIVENICKNAMECAPTURED]                 = COMPOUND_STRING("Would you like to give {B_DEF_NAME} a nickname?"),
    [STRINGID_PKMNDATAADDEDTODEX]                   = COMPOUND_STRING("{B_DEF_NAME}'s data has been added to the TohoDex!\p"),
    ...
    [STRINGID_ENEMYABOUTTOSWITCHPKMN]               = COMPOUND_STRING("{B_TRAINER1_NAME_WITH_CLASS} is about to send out {B_BUFF2}. Will you switch your Puppet?"),
    ...
    [STRINGID_ITSUCKEDLIQUIDOOZE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} sucked up the strange mist!"),
    ...
    [STRINGID_USENEXTPKMN]                          = COMPOUND_STRING("Use next Puppet?"),
    ...
    [STRINGID_HELDITEMSLOSEEFFECTS]                 = COMPOUND_STRING("It created a bizarre area in which Puppets' held items lose their effects!"),
    ...
    [STRINGID_TOOMUCHHONEY]                         = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} boiled so much honey that there was some left over!"),
    [STRINGID_HONEYCHIPHEAL]                        = COMPOUND_STRING("Some leftover honey restored {B_ATK_NAME_WITH_PREFIX2}'s HP!"),
    [STRINGID_HONEYCHIPENDS]                        = COMPOUND_STRING("All the leftover honey was eaten up!"),
    ...
    [STRINGID_HARVESTHONEY]                         = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} harvested its {B_LAST_ITEM}!"),
    ...
    [STRINGID_POWDEREXPLODES]                       = COMPOUND_STRING("When the flame touched the powder on the Puppet, it exploded!"),
    ...
    [STRINGID_AURABREAKENTERS]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} reversed all other Puppets' auras!"),
    ...
    [STRINGID_PKMNSWILLPERISHIN3TURNS]              = COMPOUND_STRING("Both Puppets will faint in three turns!"),
    ...
    [STRINGID_MYSTERIOUSAIRCURRENT]                 = COMPOUND_STRING("Mysterious strong winds are protecting Flying-type Puppets!"),
    ...
    [STRINGID_BOTHCANNOLONGERESCAPE]                = COMPOUND_STRING("Neither Puppet can run away!"),
    ...
    [STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSTAT]   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} weakened the {B_BUFF1} of all surrounding Puppets!\p"),
    ...
    [STRINGID_SHARPSTEELFLOATS]                     = COMPOUND_STRING("Sharp-pointed pieces of steel started floating around {B_DEF_TEAM2} Puppets!"),
    ...
    [STRINGID_SHARPSTEELDISAPPEAREDFROMTEAM]        = COMPOUND_STRING("The pieces of steel surrounding {B_ATK_TEAM2} Puppets disappeared!"),
    [STRINGID_TEAMTRAPPEDWITHVINES]                 = COMPOUND_STRING("{B_EFF_TEAM1} Puppets got trapped with vines!"),
    [STRINGID_PKMNHURTBYVINES]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by G-Max Vine Lash's ferocious beating!"),
    [STRINGID_TEAMCAUGHTINVORTEX]                   = COMPOUND_STRING("{B_EFF_TEAM1} Puppets got caught in a vortex of water!"),
    [STRINGID_PKMNHURTBYVORTEX]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by G-Max Cannonade's vortex!"),
    [STRINGID_TEAMSURROUNDEDBYFIRE]                 = COMPOUND_STRING("{B_EFF_TEAM1} Puppets were surrounded by fire!"),
    [STRINGID_PKMNBURNINGUP]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is burning up within G-Max Wildfire's flames!"),
    [STRINGID_TEAMSURROUNDEDBYROCKS]                = COMPOUND_STRING("{B_EFF_TEAM1} Puppets became surrounded by rocks!"),
    ...
    [STRINGID_BIZARREARENACREATED]                  = COMPOUND_STRING("A bizarre area was created in which Puppets' held items lose their effects!"),
    ...
    [STRINGID_MONHEARINGFLUTEAWOKE]                 = COMPOUND_STRING("The Puppets hearing the flute awoke!"),
    ...
    [STRINGID_PKMNALREADYHASFROSTBITE]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is already frostbit!"),
    [STRINGID_PKMNDROPPEDITEM]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} dropped its {B_LAST_ITEM}!{WAIT_SE}\p"),
    [STRINGID_BAGISFULL]                            = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} dropped its {B_LAST_ITEM}!{WAIT_SE}\pBut your bag is full!\p"),
    ...
    [STRINGID_PKMNFROSTBITBY]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_BUFF1} frostbit {B_EFF_NAME_WITH_PREFIX2}!"), //not in gen 5+, ability popup
    [STRINGID_FELTBETTERWITHABILITY]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} felt better with its {B_ATK_ABILITY}!"),
    [STRINGID_EFFFELTBETTERWITHABILITY]             = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} felt better with its {B_DEF_ABILITY}!"),
    ...
    [STRINGID_BOMBORBTOOKDAMAGE]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} took damage from the {B_LAST_ITEM}!"),
...
const u16 gTerrainStringIds[B_MSG_TERRAIN_COUNT] =
{
    ...
    [B_MSG_TERRAIN_END_HOLY] = STRINGID_HOLYTERRAINENDS,
};
...
const u16 gWrappedStringIds[NUM_TRAPPING_MOVES] =
{
    ...
    [B_MSG_WRAPPED_CLAMP]       = STRINGID_PKMNCLAMPED,            // MOVE_MANA_SHIELD
    ...
    [B_MSG_WRAPPED_MAD_HONEY]   = STRINGID_INFESTATION,            // MOVE_MAD_HONEY
...
const u16 gTerrainStartsStringIds[] =
{
    ...
    [B_MSG_TERRAIN_SET_HOLY]     = STRINGID_HOLYSURROUNDSBATTLEFIELD,
};
...
const u16 gRoomsStringIds[] =
{
    ...
    STRINGID_SWAPSTYPEEFFECTIVENESS, STRINGID_INVERSEROOMENDS,
...
const u8 gText_SafariBalls[] = _("Safari Orbs");
