...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_HITXTIMES]                            = COMPOUND_STRING("The Puppet was hit {B_BUFF1} time{B_BUFF2}!"),
    ...
    [STRINGID_BELCHCANTSELECT]                      = COMPOUND_STRING("Your Puppet can't use this move because it hasn't eaten any Berries!\p"),
