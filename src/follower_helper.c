...
static const u8 sCondMsg07[] = _("Your Puppet is staring intently at\nthe mountain peak.");
static const u8 sCondMsg08[] = _("Sniff sniff, something smells good!");
static const u8 sCondMsg09[] = _("Your Puppet is surveying the\nshelves restlessly.");
...
static const u8 sCondMsg18[] = _("Waah! Your Puppet suddenly splashed\nwater!");
static const u8 sCondMsg19[] = _("Your Puppet is blowing sand in the\nair!");
static const u8 sCondMsg20[] = _("{STR_VAR_1} is playing around,\nplucking bits of grass.");
static const u8 sCondMsg21[] = _("Your Puppet is happily looking at\nyour footprints!");
...
static const u8 sCondMsg25[] = _("Your Puppet almost slipped and fell\nover!");
static const u8 sCondMsg26[] = _("Your Puppet seems surprised to\ntouch ice.");
static const u8* const sColdTexts[] = {sCondMsg24, sCondMsg25, sCondMsg26, NULL};
static const u8 sCondMsg27[] = _("Your Puppet has a flower petal on\nits face!");
...
static const u8 sCondMsg34[] = _("Your Puppet is staring intently at\nthe sea!");
...
const struct FollowerMsgInfoExtended gFollowerConditionalMessages[COND_MSG_COUNT] =
{
    ...
    [COND_MSG_ICE_ROOM] =
    {
        ...
        .conditions =
        {
            ...
            MATCH_MAP(MAP_GRANITE_CAVE_1F),
            MATCH_MAP(MAP_GRANITE_CAVE_B1F),
            MATCH_MAP(MAP_GRANITE_CAVE_B2F),
            MATCH_MAP(MAP_GRANITE_CAVE_STEVENS_ROOM),
        },
    },
    [COND_MSG_ROUTE_117] =
    {
    ...
    [COND_MSG_ABNORMAL_WEATHER] =
    {
        ...
        .conditions =
        {
            ...
            MATCH_NOT_SPECIES(SPECIES_LAST_WORD_SUWAKO),
            MATCH_NOT_SPECIES(SPECIES_LAST_WORD_UTSUHO),
            MATCH_NOT_SPECIES(SPECIES_LAST_WORD_KANAKO),
        }
    },
};
