...
static const struct PokeBallParticles sBallParticles[POKEBALL_COUNT] =
{
    ...
    [BALL_FOUL] =
    {
        POKE_BALL_ANIMATION(TAG_PARTICLES_FOUL_BALL, gBattleAnimSpriteGfx_Particles, gBattleAnimSpritePal_CircleImpact),
    ...
    [BALL_POKE2] =
    {
        POKE_BALL_ANIMATION(TAG_PARTICLES_POKE_BALL2, gBattleAnimSpriteGfx_Particles, gBattleAnimSpritePal_CircleImpact),
        .openFadeColor = RGB(31, 22, 30),
        .animNums = 0,
        .particleAnimationFunc = PokeBallOpenParticleAnimation,
    },
    ...
    [BALL_GREAT2] =
    {
        POKE_BALL_ANIMATION(TAG_PARTICLES_GREAT_BALL2, gBattleAnimSpriteGfx_Particles, gBattleAnimSpritePal_CircleImpact),
        .openFadeColor = RGB(16, 23, 30),
        .animNums = 0,
        .particleAnimationFunc = GreatBallOpenParticleAnimation,
    },
    ...
    [BALL_ULTRA2] =
    {
        POKE_BALL_ANIMATION(TAG_PARTICLES_ULTRA_BALL2, gBattleAnimSpriteGfx_Particles, gBattleAnimSpritePal_CircleImpact),
        .openFadeColor = RGB(31, 31, 15),
        .animNums = 5,
        .particleAnimationFunc = UltraBallOpenParticleAnimation,
    },
