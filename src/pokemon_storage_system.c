...
static const u8 gText_JustOnePkmn[] = _("There is just one Puppet with you.");
...
{
    [OPTION_WITHDRAW]   = {COMPOUND_STRING("Withdraw Puppets"), COMPOUND_STRING("Move Puppets stored in Boxes to\nyour party.")},
    [OPTION_DEPOSIT]    = {COMPOUND_STRING("Deposit Puppets"),  COMPOUND_STRING("Store Puppets in your party in Boxes.")},
    [OPTION_MOVE_MONS]  = {COMPOUND_STRING("Move Puppets"),     COMPOUND_STRING("Organize the Puppets in Boxes and\nin your party.")},
    [OPTION_MOVE_ITEMS] = {COMPOUND_STRING("Move Items"),       COMPOUND_STRING("Move items held by any Puppets\nin a Box or your party.")},
...
static const struct StorageMessage sMessages[] =
{
    ...
    [MSG_RELEASE_POKE]         = {COMPOUND_STRING("Release this Puppet?"),       MSG_VAR_NONE},
    ...
    [MSG_MARK_POKE]            = {COMPOUND_STRING("Mark your Puppet."),          MSG_VAR_NONE},
    [MSG_LAST_POKE]            = {COMPOUND_STRING("That's your last Puppet!"),   MSG_VAR_NONE},
    [MSG_PARTY_FULL]           = {gText_YourPartysFull,                          MSG_VAR_NONE},
    [MSG_HOLDING_POKE]         = {COMPOUND_STRING("You're holding a Puppet!"),   MSG_VAR_NONE},
    ...
    [MSG_GIVE_TO_MON]          = {COMPOUND_STRING("Give to a Puppet?"),          MSG_VAR_NONE},
...
static u8 InBoxInput_Normal(void)
{
    ...
    do
    {
        ...
        if (gSaveBlock2Ptr->optionsLButtonMode != OPTIONS_L_BUTTON_MODE_L_EQUALS_A)
        {
...
static const u8 *const sMenuTexts[] =
{
    ...
    [MENU_CAVE]       = COMPOUND_STRING("Save"),
    ...
    [MENU_POKECENTER] = COMPOUND_STRING("PuptCenter"),
