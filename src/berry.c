...
const struct Berry gBerries[NUM_BERRIES + 1] =
{
    ...
    [BERRY_ID_PUMKIN] =
    {
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Pumkin,
        .berryPal = gBerryPalette_Pumkin,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
    ...
    [BERRY_ID_DRASH] =
    {
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Drash,
        .berryPal = gBerryPalette_Drash,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
    ...
    [BERRY_ID_EGGANT] =
    {
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Eggant,
        .berryPal = gBerryPalette_Eggant,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
    ...
    [BERRY_ID_STRIB] =
    {
        .info = {
            ...
            .color = BERRY_COLOR_GREEN,
            .size = 122,
            .maxYield = YIELD_RATE(12, 15, 20, 27),
            .minYield = YIELD_RATE(4, 4, 5, 5),
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Strib,
        .berryPal = gBerryPalette_Strib,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
    ...
    [BERRY_ID_TURLAN] =
    {
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Turlan,
        .berryPal = gBerryPalette_Turlan,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
    ...
    [BERRY_ID_NUTPEA] =
    {
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Nutpea,
        .berryPal = gBerryPalette_Nutpea,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
    ...
    [BERRY_ID_IONNO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("Peel the thin shell and the Berry"),
            .description2 = COMPOUND_STRING("becomes round. It is very sour."),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 30,
            .sweet = 0,
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Ionno,
        .berryPal = gBerryPalette_Ionno,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
    ...
    [BERRY_ID_KUO] =
    {
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Kuo,
        .berryPal = gBerryPalette_Kuo,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
    ...
    [BERRY_ID_YAGO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("Awfully bitter. So light that it"),
            .description2 = COMPOUND_STRING("feels weightless when held."),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Yago,
        .berryPal = gBerryPalette_Yago,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
    ...
    [BERRY_ID_TOUGA] =
    {
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Touga,
        .berryPal = gBerryPalette_Touga,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
    ...
    [BERRY_ID_GARLIG] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("Grows quickly, but doesn't yield"),
            .description2 = COMPOUND_STRING("much."),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 0,
            .dry = 30,
            .sweet = 0,
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Garlig,
        .berryPal = gBerryPalette_Garlig,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
    ...
    [BERRY_ID_TOPO] =
    {
        ...
        .berryCrushDifficulty = 150,
        .berryCrushPowder = 200,
        .berryPic = gBerryPic_Topo,
        .berryPal = gBerryPalette_Topo,
        .berryTreePicTable = gPicTable_DurinBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Durin,
    },
...
static enum Species GetBerryPestSpecies(u8 berryId)
{
    ...
    case BERRY_COLOR_RED:
        return P_FAMILY_LEDYBA ? SPECIES_CHIBI_SUNNY : SPECIES_NONE;
        break;
    case BERRY_COLOR_BLUE:
        return P_FAMILY_VOLBEAT_ILLUMISE ? SPECIES_CHIBI_STAR : SPECIES_NONE;
        break;
    case BERRY_COLOR_PURPLE:
        return P_FAMILY_VOLBEAT_ILLUMISE ? SPECIES_TECH_SUIKA : SPECIES_NONE;
        break;
    case BERRY_COLOR_GREEN:
        return P_FAMILY_BURMY ? SPECIES_CHIBI_DAIYOUSEI : SPECIES_NONE;
        break;
    case BERRY_COLOR_YELLOW:
        return P_FAMILY_COMBEE ? SPECIES_CHIBI_LUNA : SPECIES_NONE;
        break;
