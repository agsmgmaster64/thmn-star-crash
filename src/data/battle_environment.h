...
#define CAVE_CAMOUFLAGE_TYPE        TYPE_BEAST
...
#if B_SECRET_POWER_ANIMATION >= GEN_4
...
#define BUILDING_CAMOUFLAGE_TYPE     TYPE_ILLUSION
...
#define PLAIN_SECRET_POWER_EFFECT SECRET_POWER_ACC_MINUS_1 
#define PLAIN_CAMOUFLAGE_TYPE     TYPE_EARTH
...
const struct BattleEnvironment gBattleEnvironmentInfo[BATTLE_ENVIRONMENT_COUNT] =
{
    ...
    #endif
        .camouflageType = B_CAMOUFLAGE_TYPES >= GEN_5 ? TYPE_EARTH : TYPE_BEAST,
    ...
    [BATTLE_ENVIRONMENT_FALL_GRASS] =
    {
        ...
        .camouflageBlend = DEFAULT_CAMOUFLAGE_BLEND,
        .entry = ENVIRONMENT_ENTRY(TallGrass),
        .background = ENVIRONMENT_BACKGROUND(FallGrass),
