...
const u8 gText_MaleSymbol4[] = _("{YIN}");
const u8 gText_FemaleSymbol4[] = _("{YANG}");
...
static const u8 sText_ChooseAPkmn[] = _("Choose a nPuppet.");
...
static const struct InGameTrade sIngameTrades[] =
{
    ...
    [INGAME_TRADE_HORSEA] =
    {
        ...
        .requestedSpecies = SPECIES_CHIBI_IKU
    },
    [INGAME_TRADE_MEOWTH] =
    {
        .nickname = _("りん"),
