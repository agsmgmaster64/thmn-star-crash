static const u32 sKabutoPuzzle_Gfx[]     = INCGFX_U32("graphics/sliding_puzzle/puzzles/kabuto/tiles.png", ".4bpp.smol", "-mwidth 4 -mheight 4");
static const u32 sOmanytePuzzle_Gfx[]    = INCGFX_U32("graphics/sliding_puzzle/puzzles/omanyte/tiles.png", ".4bpp.smol", "-mwidth 4 -mheight 4");
static const u32 sAerodactylPuzzle_Gfx[] = INCGFX_U32("graphics/sliding_puzzle/puzzles/aerodactyl/tiles.png", ".4bpp.smol", "-mwidth 4 -mheight 4");
static const u32 sHoOhPuzzle_Gfx[]       = INCGFX_U32("graphics/sliding_puzzle/puzzles/ho_oh/tiles.png", ".4bpp.smol", "-mwidth 4 -mheight 4");
