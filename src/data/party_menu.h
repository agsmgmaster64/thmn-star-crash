...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_FOLLOWER]        = {COMPOUND_STRING("Follower"),        CursorCb_Follower},
    [MENU_FOLLOWER_SET]    = {COMPOUND_STRING("Set"),             CursorCb_FollowerSet},
    [MENU_FOLLOWER_RETURN] = {COMPOUND_STRING("Return"),          CursorCb_FollowerReturn},
    [MENU_FOLLOWER_UNSET]  = {COMPOUND_STRING("Unset"),           CursorCb_FollowerUnset},
    ...
    [MENU_INFLICT_FREEZE_FROSTBITE] = {COMPOUND_STRING("FRB"),    TryHexorbAndPrintResult},
#else
