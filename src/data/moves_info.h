...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_MAGIC_KNIFE] =
    {
        .name = COMPOUND_STRING("Magic Knife"),
        .description = COMPOUND_STRING(
            "Jabs the foe 2 to 5 times\n"
            "with illusionary knives."),
        .effect = EFFECT_HIT,
        .power = 25,
        .type = TYPE_REASON,
        .accuracy = 100,
    ...
    [MOVE_SCULPTURE] =
    {
        ...
        .description = COMPOUND_STRING(
            "An unavoidable volley of\n"
            "knives that never miss."),
        .effect = EFFECT_HIT,
        .power = 95,
        .type = TYPE_STEEL,
        .accuracy = 0,
    ...
    [MOVE_SEAL_NEEDLE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_SealNeedle,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_POISON_TEARS] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_PoisonTears,
    },
    ...
    [MOVE_PSYSHOT] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_Psyshot,
    },
    ...
    [MOVE_MANA_BURST] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_ManaBurst,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_BURN_POWDER] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_SWEET_SCENT},
        .battleAnimScript = gBattleAnimMove_BurnPowder,
    },
    ...
    [MOVE_MIND_BOMB] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_MindBomb,
        .validApprenticeMove = TRUE,
    },
    ...
    // Retheme this to Sekibanki's signature later
    [MOVE_BONE_CLUB] =
    {
    ...
    [MOVE_MANA_SHIELD] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_RAIN_DANCE},
        .battleAnimScript = gBattleAnimMove_ManaShield,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_TOXIC_GAS] =
    {
        ...
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_ToxicGas,
    },
    ...
    [MOVE_DISPERSE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_Disperse,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = STAT_CHANGE_EFFECT_PLUS,
            .defense = 2,
        }),
    ...
    [MOVE_GALE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
        .battleAnimScript = gBattleAnimMove_Gale,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_KILLING_BITE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_KillingBite,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_HEAT_CLAW] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_HeatClaw,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_SPIDER_WEB] =
    {
        ...
        .description = COMPOUND_STRING(
            "Ensnares the foe with a web\n"
            "which paralyzes the foe."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_NATURE,
        .accuracy = 100,
    ...
    [MOVE_POISON_BOMB] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_PoisonBomb,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_BLACK_RIPPLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Fires a dark ball to the\n"
            "foe which may paralyze."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_DARK,
        .accuracy = 100,
        ...
        .battleAnimScript = gBattleAnimMove_BlackRipple,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_CHARMING_LOOK] =
    {
        .name = COMPOUND_STRING("Charming Look"),
        .description = COMPOUND_STRING(
            "Charms the foe into using\n"
            "only damaging move."),
        .effect = EFFECT_TAUNT,
        .power = 0,
        .type = TYPE_HEART,
        ...
        .battleAnimScript = gBattleAnimMove_CharmingLook,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_PRANK] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_Prank,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_BATTLE_CHANT] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_BattleChant,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_DECISION] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_Decision,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_STEEL_FIST] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_SteelFist,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_PERFORMANCE] =
    {
        .name = COMPOUND_STRING("Performance"),
        .description = COMPOUND_STRING(
        #if B_UPROAR_TURNS >= GEN_5
            "Makes a performance for 2 to\n"
            "5 turns and prevents sleep."),
        #else
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_Performance,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_COERCE] =
    {
        ...
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_Coerce,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_BRAVER] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_Braver,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_SHADOW_DANCE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_STOCKPILE},
        .battleAnimScript = gBattleAnimMove_ShadowDance,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_GUARD] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_Guard,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_NATIVE_POWER] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_NativePower,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_MANA_CHARGE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_ManaCharge,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = STAT_CHANGE_EFFECT_PLUS,
            .spAtk = 2,
        }),
    ...
    [MOVE_SUB_ZERO] =
    {
        .name = COMPOUND_STRING("Sub-Zero"),
        .description = COMPOUND_STRING(
            "Inflicts frostbite on the\n"
            "foe with intense coldness."),
        .effect = EFFECT_NON_VOLATILE_STATUS,
        .power = 0,
        .type = TYPE_ICE,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_6 ? 85 : 75,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_HAIL},
        .battleAnimScript = gBattleAnimMove_SubZero,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_BINDING_VOICE] =
    {
        ...
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_BindingVoice,
        .validApprenticeMove = TRUE,
    },

    [MOVE_NATURE_SOUND] =
    {
        .name = COMPOUND_STRING("Nature Sound"),
        .description = COMPOUND_STRING(
        ...
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_NatureSound,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_AQUA_SHOWER] =
    {
        .name = COMPOUND_STRING("Aqua Shower"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SOAR] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_FOCUS_ENERGY},
        .battleAnimScript = gBattleAnimMove_Soar,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_SPLASHING] =
    {
        .name = COMPOUND_STRING("Splashing"),
        .description = COMPOUND_STRING(
            "An attack that gains power\n"
            "if injured by the foe."),
        .effect = EFFECT_REVENGE,
    ...
    [MOVE_PREDATOR_STALK] =
    {
        ...
        .description = COMPOUND_STRING(
            "Charges up the first turn,\n"
            "then scares next turn."),
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = 120,
        .type = TYPE_BEAST,
        .accuracy = 100,
        ...
        .assistBanned = TRUE,
        .skyBattleBanned = TRUE,
        .argument.twoTurnAttack = { .stringId = STRINGID_CHARGEDVICIOUSAURA, .state = STATE_PREDATOR_STALK },
        .contestEffect = CONTEST_EFFECT_AVOID_STARTLE_ONCE,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_METAL_SOUND},
        .battleAnimScript = gBattleAnimMove_PredatorStalk,
    },
    ...
    [MOVE_MYSTIC_WATER] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_MysticWater,
    },
    ...
    [MOVE_ENERGY_LIGHT] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_GROWTH},
        .battleAnimScript = gBattleAnimMove_EnergyLight,
    },
    ...
    [MOVE_GIGA_IMPACT] =
    {
        ...
        .description = COMPOUND_STRING(
            "A powerful attack that can\n"
            "miss and hurt the user."),
        .effect = EFFECT_RECOIL_IF_MISS,
        .power = 130,
        .type = TYPE_DARK,
        .accuracy = 90,
    ...
    [MOVE_BLADE_FLASH] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_BladeFlash,
    },
    ...
    [MOVE_SHADOW_HIT] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_ShadowHit,
    },
    ...
    [MOVE_DRAWN_LINE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_DrawnLine,
    },
    ...
    [MOVE_HOLY_TERRAIN] =
    {
        .name = COMPOUND_STRING("Holy Terrain"),
        .description = COMPOUND_STRING(
            "The ground turns holy for 5\n"
            "turns. Blocks raising stats."),
        .effect = EFFECT_TERRAIN,
        .power = 0,
        .type = TYPE_FAITH,
        .accuracy = 0,
        ...
        .contestComboStarterId = COMBO_STARTER_MISTY_TERRAIN,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_HolyTerrain,
    },
    ...
    [MOVE_MAD_HONEY] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_WRAP,
            .argument.wrapped = B_MSG_WRAPPED_MAD_HONEY,
        },
        {
    ...
    [MOVE_ROCK_BULLET] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_RockBullet,
    },
