...
const struct SpeciesInfo gSpeciesInfoTouhou11[] =
{
    ...
    [SPECIES_CHIBI_KISUME_SANNI] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_CKisumeSanni,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_GenericBlinkingAnim,
        .frontAnimId = ANIM_ZIGZAG_FAST,
        .enemyMonElevation = 5,
        .backPic = gMonBackPic_CKisumeSanni,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
        .palette = gMonPalette_CKisumeSanni,
        .shinyPalette = gMonShinyPalette_CKisumeSanni,
        .iconSprite = gMonIcon_CKisumeSanni,
        .iconPalIndex = 0,
        SHADOW(0, 14, SHADOW_SIZE_M)
        FOOTPRINT(CKisumeSanni)
        .isSannianForm = TRUE,
        .levelUpLearnset = sCKisumeSanniLevelUpLearnset,
        .teachableLearnset = sCKisumeSanniTeachableLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 23, SPECIES_NORMAL_KISUME_SANNI},
                                {EVO_ITEM, ITEM_NEUTRAL_HEART, SPECIES_NORMAL_KISUME_SANNI, CONDITIONS({IF_PAST_LEVEL, 23})}),
    },

    [SPECIES_NORMAL_KISUME_SANNI] =
    {
        .baseHP        = 75,
        .baseAttack    = 50,
        .baseDefense   = 115,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_KisumeSanni,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_GenericBlinkingAnim,
        .frontAnimId = ANIM_H_SLIDE_WOBBLE,
        .enemyMonElevation = 4,
        .backPic = gMonBackPic_KisumeSanni,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = gMonPalette_KisumeSanni,
        .shinyPalette = gMonShinyPalette_KisumeSanni,
        .iconSprite = gMonIcon_KisumeSanni,
        .iconPalIndex = 0,
        SHADOW(0, 13, SHADOW_SIZE_L)
        FOOTPRINT(KisumeSanni)
        .isSannianForm = TRUE,
        .levelUpLearnset = sKisumeSanniLevelUpLearnset,
        .teachableLearnset = sKisumeSanniTeachableLearnset,
    },
    ...
    [SPECIES_ZOMBIE_FAIRY] =
    {
        ...
        .abilities = { ABILITY_PLAY_GHOST, ABILITY_PLAY_GHOST, ABILITY_NONE },
        .sourceGame = SOURCE_SA,
        .noFlip = TRUE,
    ...
    [SPECIES_LAST_WORD_UTSUHO] =
    {
        ...
        .cryId = CRY_UTSUHO,
        .natDexNum = NATIONAL_DEX_LAST_WORD_UTSUHO,
