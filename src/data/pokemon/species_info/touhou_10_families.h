...
#define AKI_SISTERS_SPECIES_INFO(rzMode)                                                \
    ...
    [SPECIES_CHIBI_HINA] =
    {
        ...
        .abilities = { ABILITY_STRANGE_MIST, ABILITY_NATURAL_CURE, ABILITY_CURSED_BODY },
        .sourceGame = SOURCE_MOF,
        .speciesName = _("CHina"),
        .cryId = CRY_HINA,
    ...
    [SPECIES_NORMAL_HINA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_STRANGE_MIST, ABILITY_LEVITATE, ABILITY_CURSED_BODY },
        .sourceGame = SOURCE_MOF,
        .noFlip = TRUE,
        .speciesName = _("Hina"),
        .cryId = CRY_HINA,
    ...
    [SPECIES_ATTACK_HINA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_STRANGE_MIST, ABILITY_LEVITATE, ABILITY_NEUTRALIZING_GAS },
        .sourceGame = SOURCE_MOF,
        .noFlip = TRUE,
        .speciesName = _("AHina"),
        .cryId = CRY_HINA,
    ...
    [SPECIES_DEFENSE_HINA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_STRANGE_MIST, ABILITY_LEVITATE, ABILITY_MAGIC_BOUNCE },
        .sourceGame = SOURCE_MOF,
        .noFlip = TRUE,
        .speciesName = _("DHina"),
        .cryId = CRY_HINA,
    ...
    [SPECIES_CHIBI_MOMIJI_SANNI] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_CMomijiSanni,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_GenericBlinkingAnim,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = 1,
        .backPic = gMonBackPic_CMomijiSanni,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_CMomijiSanni,
        .shinyPalette = gMonShinyPalette_CMomijiSanni,
        .iconSprite = gMonIcon_CMomijiSanni,
        .iconPalIndex = 1,
        SHADOW(1, 10, SHADOW_SIZE_M)
        FOOTPRINT(CMomijiSanni)
        .isSannianForm = TRUE,
        .levelUpLearnset = sCMomijiSanniLevelUpLearnset,
        .teachableLearnset = sCMomijiSanniTeachableLearnset,
        .formSpeciesIdTable = sCMomijiFormSpeciesIdTable,
    ...
    [SPECIES_NORMAL_MOMIJI_SANNI] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_MomijiSanni,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_GenericBlinkingAnim,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = 2,
        .backPic = gMonBackPic_MomijiSanni,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_MomijiSanni,
        .shinyPalette = gMonShinyPalette_MomijiSanni,
        .iconSprite = gMonIcon_MomijiSanni,
        .iconPalIndex = 1,
        SHADOW(0, 10, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(MomijiSanni)
        .isSannianForm = TRUE,
        .levelUpLearnset = sMomijiSanniLevelUpLearnset,
        .teachableLearnset = sMomijiSanniTeachableLearnset,
        .formSpeciesIdTable = sMomijiFormSpeciesIdTable,
    },
    ...
    [SPECIES_CHIBI_SANAE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_UNWAVERING, ABILITY_MOLD_BREAKER },
        .sourceGame = SOURCE_MOF,
        .noFlip = TRUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_NORMAL_SANAE},
                                ...
                                {EVO_ITEM, ITEM_CHROME_HEART, SPECIES_JOSHI_KOSEI_SANAE, CONDITIONS({IF_PAST_LEVEL, 36})}),
    },
    ...
    [SPECIES_JOSHI_KOSEI_SANAE] =
    {
        ...
        .natDexNum = NATIONAL_DEX_JOSHI_KOSEI_SANAE,
    ...
    [SPECIES_LAST_WORD_KANAKO] =
    {
        ...
        .cryId = CRY_KANAKO,
        .natDexNum = NATIONAL_DEX_LAST_WORD_KANAKO,
