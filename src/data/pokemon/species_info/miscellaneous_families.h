...
const struct SpeciesInfo gSpeciesInfoMiscellaneous[] =
{
    ...
    [SPECIES_CHIBI_APPLE] =
    {
        ...
        .abilities = { ABILITY_RIPEN, ABILITY_GLUTTONY, ABILITY_SUPERSWEET_SYRUP },
        .sourceGame = SOURCE_OTHER,
        .noFlip = TRUE,
        .speciesName = _("CApple"),
        .cryId = CRY_PORYGON,
        .natDexNum = NATIONAL_DEX_CHIBI_APPLE,
        .categoryName = _("Fang Scorp"),
        .height = 20,
        .weight = 425,
        .description = COMPOUND_STRING(
        ...
        .trainerScale = 334,
        .trainerOffset = 4,
        .frontPic = gMonFrontPic_CApple,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_GenericBlinkingAnim,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_CApple,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_CApple,
        .shinyPalette = gMonShinyPalette_CApple,
        .iconSprite = gMonIcon_CApple,
        .iconPalIndex = 2,
        FOOTPRINT(CApple)
        .levelUpLearnset = sCAppleLevelUpLearnset,
        .teachableLearnset = sCAppleTeachableLearnset,
    },

    [SPECIES_NORMAL_APPLE] =
    {
        .baseHP        = 120,
        .baseAttack    = 50,
        .baseDefense   = 75,
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_NATURE, TYPE_HEART),
        .catchRate = 120,
        .expYield = 240,
        .evYield_SpAttack = 1,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .speciesName = _("Apple"),
        .cryId = CRY_PORYGON,
        .natDexNum = NATIONAL_DEX_NORMAL_APPLE,
        .categoryName = _("Fang Scorp"),
        .height = 20,
        .weight = 425,
        .description = COMPOUND_STRING(
        ...
        .trainerScale = 334,
        .trainerOffset = 4,
        .frontPic = gMonFrontPic_Apple,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_GenericBlinkingAnim,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_Apple,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Apple,
        .shinyPalette = gMonShinyPalette_Apple,
        .iconSprite = gMonIcon_Apple,
        .iconPalIndex = 2,
        FOOTPRINT(Apple)
        .levelUpLearnset = sAppleLevelUpLearnset,
