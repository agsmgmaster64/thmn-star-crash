...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU, CONDITIONS({IF_NOT_REGION, POKEMON_REGION_SANNI})}
                            #if P_ALOLAN_FORMS
                                ,{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLA, CONDITIONS({IF_REGION, POKEMON_REGION_SANNI})}
                            #endif
                            ),
    },
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR, CONDITIONS({IF_NOT_REGION, POKEMON_REGION_SANNI})}
                            #if P_ALOLAN_FORMS
                                ,{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLA, CONDITIONS({IF_REGION, POKEMON_REGION_SANNI})}
                            #endif
                            ),
    },
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MAROWAK, CONDITIONS({IF_NOT_REGION, POKEMON_REGION_SANNI})}
                            #if P_ALOLAN_FORMS
                                ,{EVO_LEVEL, 28, SPECIES_MAROWAK_ALOLA, CONDITIONS({IF_REGION, POKEMON_REGION_SANNI}, {IF_TIME, TIME_NIGHT})},
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_WEEZING, CONDITIONS({IF_NOT_REGION, POKEMON_REGION_GALAR})}
                            #if P_GALARIAN_FORMS
                                ,{EVO_LEVEL, 35, SPECIES_WEEZING_GALAR, CONDITIONS({IF_REGION, POKEMON_REGION_GALAR})}
                            #endif
                            ),
    },
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MR_MIME, CONDITIONS({IF_KNOWS_MOVE, MOVE_MIMIC}, {IF_NOT_REGION, POKEMON_REGION_GALAR})}
                            #if P_GALARIAN_FORMS
                                ,{EVO_LEVEL, 0, SPECIES_MR_MIME_GALAR, CONDITIONS({IF_KNOWS_MOVE, MOVE_MIMIC}, {IF_REGION, POKEMON_REGION_GALAR})}
                            #endif
                            ),
    },
#endif //P_GEN_4_CROSS_EVOS
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
    ...
    [SPECIES_PORYGON_Z] =
    {
        ...
        .cryId = CRY_PORYGON_Z,
        .natDexNum = NATIONAL_DEX_TECH_ICHIRIN,
        .categoryName = _("Virtual"),
        .height = 9,
        .weight = 340,
        .description = COMPOUND_STRING(
