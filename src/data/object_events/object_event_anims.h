...
static const union AnimCmd sAnim_FaceEast_Asym[] =
{
    ANIMCMD_FRAME(3, 16),
    ANIMCMD_JUMP(0),
};
...
static const union AnimCmd sAnim_GoSouth_Asym[] =
{
    ANIMCMD_FRAME(4, 8),
    ANIMCMD_FRAME(0, 8),
    ANIMCMD_FRAME(5, 8),
...
static const union AnimCmd sAnim_GoNorth_Asym[] =
{
    ANIMCMD_FRAME(6, 8),
    ANIMCMD_FRAME(1, 8),
    ANIMCMD_FRAME(7, 8),
...
static const union AnimCmd sAnim_GoWest_Asym[] =
{
    ANIMCMD_FRAME(8, 8),
    ANIMCMD_FRAME(2, 8),
    ANIMCMD_FRAME(9, 8),
...
static const union AnimCmd sAnim_GoEast_Asym[] =
{
    ANIMCMD_FRAME(10, 8),
    ANIMCMD_FRAME( 3, 8),
    ANIMCMD_FRAME(11, 8),
...
static const union AnimCmd sAnim_GoFastNorth_Asym[] =
{
    ANIMCMD_FRAME(6, 4),
    ANIMCMD_FRAME(1, 4),
    ANIMCMD_FRAME(7, 4),
...
static const union AnimCmd sAnim_GoFastWest_Asym[] =
{
    ANIMCMD_FRAME(8, 4),
    ANIMCMD_FRAME(2, 4),
    ANIMCMD_FRAME(9, 4),
...
static const union AnimCmd sAnim_GoFastEast_Asym[] =
{
    ANIMCMD_FRAME(10, 4),
    ANIMCMD_FRAME( 3, 4),
    ANIMCMD_FRAME(11, 4),
...
static const union AnimCmd sAnim_GoFasterSouth_Asym[] =
{
    ANIMCMD_FRAME(4, 2),
    ANIMCMD_FRAME(0, 2),
    ANIMCMD_FRAME(5, 2),
...
static const union AnimCmd sAnim_GoFasterNorth_Asym[] =
{
    ANIMCMD_FRAME(6, 2),
    ANIMCMD_FRAME(1, 2),
    ANIMCMD_FRAME(7, 2),
...
static const union AnimCmd sAnim_GoFasterWest_Asym[] =
{
    ANIMCMD_FRAME(8, 2),
    ANIMCMD_FRAME(2, 2),
    ANIMCMD_FRAME(9, 2),
...
static const union AnimCmd sAnim_GoFasterEast_Asym[] =
{
    ANIMCMD_FRAME(10, 2),
    ANIMCMD_FRAME( 3, 2),
    ANIMCMD_FRAME(11, 2),
...
static const union AnimCmd *const sAnimTable_Standard_Asym[] = {
    ...
    [ANIM_STD_FACE_NORTH] = sAnim_FaceNorth,
    [ANIM_STD_FACE_WEST] = sAnim_FaceWest,
    [ANIM_STD_FACE_EAST] = sAnim_FaceEast_Asym,
    [ANIM_STD_GO_SOUTH] = sAnim_GoSouth_Asym,
    [ANIM_STD_GO_NORTH] = sAnim_GoNorth_Asym,
    [ANIM_STD_GO_WEST] = sAnim_GoWest_Asym,
    [ANIM_STD_GO_EAST] = sAnim_GoEast_Asym,
    [ANIM_STD_GO_FAST_SOUTH] = sAnim_GoFastSouth_Asym,
    [ANIM_STD_GO_FAST_NORTH] = sAnim_GoFastNorth_Asym,
    [ANIM_STD_GO_FAST_WEST] = sAnim_GoFastWest_Asym,
    [ANIM_STD_GO_FAST_EAST] = sAnim_GoFastEast_Asym,
    [ANIM_STD_GO_FASTER_SOUTH] = sAnim_GoFasterSouth_Asym,
    [ANIM_STD_GO_FASTER_NORTH] = sAnim_GoFasterNorth_Asym,
    [ANIM_STD_GO_FASTER_WEST] = sAnim_GoFasterWest_Asym,
    [ANIM_STD_GO_FASTER_EAST] = sAnim_GoFasterEast_Asym,
    [ANIM_STD_GO_FASTEST_SOUTH] = sAnim_GoFastestSouth,
    [ANIM_STD_GO_FASTEST_NORTH] = sAnim_GoFastestNorth,
    [ANIM_STD_GO_FASTEST_WEST] = sAnim_GoFastestWest,
    [ANIM_STD_GO_FASTEST_EAST] = sAnim_GoFastestEast,
...
static const union AnimCmd *const sAnimTable_PlayableNPC[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_FaceSouth,
    [ANIM_STD_FACE_NORTH] = sAnim_FaceNorth,
    [ANIM_STD_FACE_WEST] = sAnim_FaceWest,
    [ANIM_STD_FACE_EAST] = sAnim_FaceEast,
