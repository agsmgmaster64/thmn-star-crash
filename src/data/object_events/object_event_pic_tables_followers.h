...
static const struct SpriteFrameImage sPicTable_CReimu[] = {
    overworld_ascending_frames(gObjectEventPic_CReimu, 4, 4),
};
static const struct SpriteFrameImage sPicTable_Reimu[] = {
    overworld_ascending_frames(gObjectEventPic_Reimu, 4, 4),
};
static const struct SpriteFrameImage sPicTable_AReimu[] = {
    overworld_ascending_frames(gObjectEventPic_AReimu, 4, 4),
};
static const struct SpriteFrameImage sPicTable_DReimu[] = {
    overworld_ascending_frames(gObjectEventPic_DReimu, 4, 4),
};

static const struct SpriteFrameImage sPicTable_CMarisa[] = {
    overworld_ascending_frames(gObjectEventPic_CMarisa, 4, 4),
};
static const struct SpriteFrameImage sPicTable_Marisa[] = {
    overworld_ascending_frames(gObjectEventPic_Marisa, 4, 4),
};
static const struct SpriteFrameImage sPicTable_AMarisa[] = {
    overworld_ascending_frames(gObjectEventPic_AMarisa, 4, 4),
};
static const struct SpriteFrameImage sPicTable_SMarisa[] = {
    overworld_ascending_frames(gObjectEventPic_SMarisa, 4, 4),
};
...
static const struct SpriteFrameImage sPicTable_CAlice[] = {
    overworld_ascending_frames(gObjectEventPic_CAlice, 4, 4),
};
static const struct SpriteFrameImage sPicTable_Alice[] = {
    overworld_ascending_frames(gObjectEventPic_Alice, 4, 4),
};
static const struct SpriteFrameImage sPicTable_AAlice[] = {
    overworld_ascending_frames(gObjectEventPic_AAlice, 4, 4),
};
static const struct SpriteFrameImage sPicTable_TAlice[] = {
    overworld_ascending_frames(gObjectEventPic_TAlice, 4, 4),
};
...
static const struct SpriteFrameImage sPicTable_CChen[] = {
    overworld_ascending_frames(gObjectEventPic_CChen, 4, 4),
};
static const struct SpriteFrameImage sPicTable_Chen[] = {
    overworld_ascending_frames(gObjectEventPic_Chen, 4, 4),
};
static const struct SpriteFrameImage sPicTable_AChen[] = {
    overworld_ascending_frames(gObjectEventPic_AChen, 4, 4),
};
static const struct SpriteFrameImage sPicTable_TChen[] = {
    overworld_ascending_frames(gObjectEventPic_TChen, 4, 4),
};

static const struct SpriteFrameImage sPicTable_CMystia[] = {
    overworld_ascending_frames(gObjectEventPic_CMystia, 4, 4),
};
static const struct SpriteFrameImage sPicTable_Mystia[] = {
    overworld_ascending_frames(gObjectEventPic_Mystia, 4, 4),
};
static const struct SpriteFrameImage sPicTable_AMystia[] = {
    overworld_ascending_frames(gObjectEventPic_AMystia, 4, 4),
};
static const struct SpriteFrameImage sPicTable_HMystia[] = {
    overworld_ascending_frames(gObjectEventPic_HMystia, 4, 4),
};
...
static const struct SpriteFrameImage sPicTable_CMedicine[] = {
    overworld_ascending_frames(gObjectEventPic_CMedicine, 4, 4),
};
static const struct SpriteFrameImage sPicTable_Medicine[] = {
    overworld_ascending_frames(gObjectEventPic_Medicine, 4, 4),
};
static const struct SpriteFrameImage sPicTable_AMedicine[] = {
    overworld_ascending_frames(gObjectEventPic_AMedicine, 4, 4),
};
static const struct SpriteFrameImage sPicTable_SMedicine[] = {
    overworld_ascending_frames(gObjectEventPic_SMedicine, 4, 4),
};
static const struct SpriteFrameImage sPicTable_TMedicine[] = {
    overworld_ascending_frames(gObjectEventPic_TMedicine, 4, 4),
};
...
static const struct SpriteFrameImage sPicTable_CSanae[] = {
    overworld_ascending_frames(gObjectEventPic_CSanae, 4, 4),
};
static const struct SpriteFrameImage sPicTable_Sanae[] = {
    overworld_ascending_frames(gObjectEventPic_Sanae, 4, 4),
};
static const struct SpriteFrameImage sPicTable_ASanae[] = {
    overworld_ascending_frames(gObjectEventPic_ASanae, 4, 4),
};
static const struct SpriteFrameImage sPicTable_TSanae[] = {
    overworld_ascending_frames(gObjectEventPic_TSanae, 4, 4),
};

static const struct SpriteFrameImage sPicTable_CHina[] = {
    overworld_ascending_frames(gObjectEventPic_CHina, 4, 4),
};
static const struct SpriteFrameImage sPicTable_Hina[] = {
    overworld_ascending_frames(gObjectEventPic_Hina, 4, 4),
};
static const struct SpriteFrameImage sPicTable_AHina[] = {
    overworld_ascending_frames(gObjectEventPic_AHina, 4, 4),
};
static const struct SpriteFrameImage sPicTable_DHina[] = {
    overworld_ascending_frames(gObjectEventPic_DHina, 4, 4),
};
...
static const struct SpriteFrameImage sPicTable_Kagerou[] = {
    overworld_ascending_frames(gObjectEventPic_Kagerou, 4, 4),
};

static const struct SpriteFrameImage sPicTable_CWakasagihime[] = {
    overworld_ascending_frames(gObjectEventPic_CWakasagihime, 4, 4),
};
static const struct SpriteFrameImage sPicTable_Wakasagihime[] = {
    overworld_ascending_frames(gObjectEventPic_Wakasagihime, 4, 4),
};
...
static const struct SpriteFrameImage sPicTable_CMike[] = {
    overworld_ascending_frames(gObjectEventPic_CMike, 4, 4),
};
static const struct SpriteFrameImage sPicTable_Mike[] = {
    overworld_ascending_frames(gObjectEventPic_Mike, 4, 4),
};
