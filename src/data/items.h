...
static const u8 sFigyBerryDesc[]      = _("A berry that\n"
                                          "restores HP but\n"
                                          "may confuse.");
...
// Poké Balls
    ...
    [ITEM_POKE_BALL_HISUI] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_Pokeball,
        .battleUsage = EFFECT_ITEM_THROW_BALL,
        .secondaryId = BALL_POKE2,
        .iconPic = gItemIcon_PokeBallHisui,
        .iconPalette = gItemIconPalette_PokeBallHisui,
    },
    ...
    [ITEM_GREAT_BALL_HISUI] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_Pokeball,
        .battleUsage = EFFECT_ITEM_THROW_BALL,
        .secondaryId = BALL_GREAT2,
        .iconPic = gItemIcon_GreatBallHisui,
        .iconPalette = gItemIconPalette_GreatBallHisui,
    },
...
// Regional Specialties
    ...
    [ITEM_SCARLET_TEA] =
    {
        .name = ITEM_NAME("Scarlet Tea"),
        .pluralName = ITEM_PLURAL_NAME("Scarlet Tea"),
        .price = 100,
        .holdEffectParam = 20,
        .description = COMPOUND_STRING(
            "A cup of tea\n"
    ...
    [ITEM_GEYSER_WATER] =
    {
        ...
        .effect = gItemEffect_SodaPop,
        .flingPower = 30,
        .iconPic = gItemIcon_GeyserWater,
        .iconPalette = gItemIconPalette_GeyserWater,
    },

    [ITEM_BEER_BOTTLE] =
    {
        .name = ITEM_NAME("Beer Bottle"),
        .price = 600,
        .description = COMPOUND_STRING(
            "A bottle of beer\n"
            "that restores HP\n"
        ...
        .effect = gItemEffect_MoomooMilk,
        .flingPower = 30,
        .iconPic = gItemIcon_BeerBottle,
        .iconPalette = gItemIconPalette_BeerBottle,
    },

    [ITEM_UNAGI_LUNCH] =
    {
        .name = ITEM_NAME("Unagi Lunch"),
        .pluralName = ITEM_PLURAL_NAME("Unagi Lunches"),
        .price = 900,
        .holdEffectParam = 150,
        .description = COMPOUND_STRING(
            "A meal with unagi\n"
        ...
        .flingPower = 30,
        .iconPic = gItemIcon_UnagiLunch,
        .iconPalette = gItemIconPalette_UnagiLunch,
    },

    [ITEM_SAKE_GOURD] =
    {
        .name = ITEM_NAME("Sake Gourd"),
        ...
        .effect = gItemEffect_MaxPotion,
        .flingPower = 30,
        .iconPic = gItemIcon_SakeGourd,
        .iconPalette = gItemIconPalette_SakeGourd,
    },
    ...
    [ITEM_HEAVEN_PEACH] =
    {
        .name = ITEM_NAME("Heavenly Peach"),
        .pluralName = ITEM_PLURAL_NAME("Heavenly Peaches"),
        .price = (I_PRICE >= GEN_7) ? 350 : 200,
        .description = sFullHealDesc,
        .pocket = POCKET_MEDICINE,
        .sortType = ITEM_TYPE_STATUS_RECOVERY,
        ...
        .effect = gItemEffect_FullHeal,
        .flingPower = 30,
        .iconPic = gItemIcon_HeavenPeach,
        .iconPalette = gItemIconPalette_HeavenPeach,
    },
...
// Treasures
    ...
    [ITEM_GREEN_UFO] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
        .iconPic = gItemIcon_UFO,
        .iconPalette = gItemIconPalette_GreenUFO,
    },

    [ITEM_RED_UFO] =
    {
        .name = ITEM_NAME("Red UFO"),
        ...
        .flingPower = 30,
        .iconPic = gItemIcon_UFO,
        .iconPalette = gItemIconPalette_RedUFO,
    },

    [ITEM_BLUE_UFO] =
    {
        .name = ITEM_NAME("Blue UFO"),
    #if I_PRICE >= GEN_7
        ...
        .flingPower = 30,
        .iconPic = gItemIcon_UFO,
        .iconPalette = gItemIconPalette_BlueUFO,
    },
...
// Species-specific Held Items
    ...
    [ITEM_ICY_BALL] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
        .iconPic = gItemIcon_IcyBall,
        .iconPalette = gItemIconPalette_IcyBall,
    },

    [ITEM_ASSIST_BALL] =
    {
        .name = ITEM_NAME("Assist Ball"),
        .price = (I_PRICE >= GEN_7) ? 1000 : 200,
        .holdEffect = HOLD_EFFECT_ASSIST_BALL,
        .description = COMPOUND_STRING(
            "A hold item that\n"
            "raises Ditto's\n"
            "Defense."),
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
        .iconPic = gItemIcon_AssistBall,
        .iconPalette = gItemIconPalette_AssistBall,
    },

    [ITEM_MUSIC_BALL] =
    {
        .name = ITEM_NAME("Music Ball"),
        .price = (I_PRICE >= GEN_7) ? 1000 : 100,
        .holdEffect = HOLD_EFFECT_MUSIC_BALL,
        .holdEffectParam = 20,
        .description = COMPOUND_STRING(
            "Boosts the power of\n"
            "Dialga's Dragon and\n"
    ...
    [ITEM_GLOW_BALL] =
    {
        .name = ITEM_NAME("Glow Ball"),
        .price = (I_PRICE >= GEN_7) ? 1000 : 100,
        .holdEffect = HOLD_EFFECT_GLOW_BALL,
        .holdEffectParam = 20,
        .description = COMPOUND_STRING(
            "Boosts the power of\n"
            "Palkia's Dragon and\n"
    ...
    [ITEM_DARK_BALL] =
    {
        .name = ITEM_NAME("Dark Ball"),
        .price = (I_PRICE >= GEN_7) ? 1000 : 100,
        .holdEffect = HOLD_EFFECT_DARK_BALL,
        .holdEffectParam = 20,
        .description = COMPOUND_STRING(
    ...
    [ITEM_BLOOMERS] =
    {
        .name = ITEM_NAME("Bloomers"),
        .pluralName = ITEM_PLURAL_NAME("Bloomers"),
        .price = (I_PRICE >= GEN_7) ? 1000 : 200,
        .holdEffect = HOLD_EFFECT_BLOOMERS,
        .description = COMPOUND_STRING(
            "Ups the critical-\n"
            "hit ratio for\n"
            "Ran's forms."),
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 60,
        .iconPic = gItemIcon_Bloomers,
        .iconPalette = gItemIconPalette_Bloomers,
    },

    [ITEM_DARK_RIBBON] =
    {
        .name = ITEM_NAME("Dark Ribbon"),
        .price = (I_PRICE >= GEN_7) ? 1000 : 500,
        .holdEffect = HOLD_EFFECT_DARK_RIBBON,
        .description = COMPOUND_STRING(
            "A hold item that\n"
            "raises Attack for\n"
            "Hina's forms."),
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 90,
        .iconPic = gItemIcon_DarkRibbon,
        .iconPalette = gItemIconPalette_DarkRibbon,
    },

    [ITEM_BIG_CLOUD] =
    {
        .name = ITEM_NAME("Big Cloud"),
        .price = (I_PRICE >= GEN_7) ? 1000 : 10,
        .holdEffect = HOLD_EFFECT_BIG_CLOUD,
        .description = COMPOUND_STRING(
            "Ups the critical-\n"
            "hit ratio for\n"
            "Ichirin's forms."),
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 40,
        .iconPic = gItemIcon_BigCloud,
        .iconPalette = gItemIconPalette_BigCloud,
    },
    ...
    [ITEM_DOUBLE_SOUL] =
    {
        .name = ITEM_NAME("Double Soul"),
        .price = (I_PRICE >= GEN_7) ? 0 : 200,
        .holdEffect = HOLD_EFFECT_DOUBLE_SOUL,
...
// Type-boosting Held Items
    ...
    [ITEM_BRIDAL_GOWN] =
    {
        ...
        .secondaryId = TYPE_ILLUSION,
        .flingPower = 10,
        .iconPic = gItemIcon_BridalGown,
        .iconPalette = gItemIconPalette_BridalGown,
    },

    [ITEM_GOTHIC_DRESS] =
    {
        .name = ITEM_NAME("Gothic Dress"),
        .pluralName = ITEM_PLURAL_NAME("Gothic Dresses"),
        .price = TYPE_BOOSTING_PRICE,
        .holdEffect = HOLD_EFFECT_TYPE_POWER,
        .holdEffectParam = TYPE_BOOST_PARAM,
        .description = COMPOUND_STRING(
        ...
        .secondaryId = TYPE_FIRE,
        .flingPower = 30,
        .iconPic = gItemIcon_GothicDress,
        .iconPalette = gItemIconPalette_GothicDress,
    },

    [ITEM_SWIMSUIT] =
    {
        .name = ITEM_NAME("Swimsuit"),
        .price = TYPE_BOOSTING_PRICE,
        .holdEffect = HOLD_EFFECT_TYPE_POWER,
        .holdEffectParam = TYPE_BOOST_PARAM,
        .description = COMPOUND_STRING(
        ...
        .secondaryId = TYPE_WATER,
        .flingPower = 30,
        .iconPic = gItemIcon_Swimsuit,
        .iconPalette = gItemIconPalette_Swimsuit,
    },
    ...
    [ITEM_NINJA_SUIT] =
    {
        ...
        .secondaryId = TYPE_ELECTRIC,
        .flingPower = 30,
        .iconPic = gItemIcon_NinjaSuit,
        .iconPalette = gItemIconPalette_NinjaSuit,
    },
    ...
    [ITEM_CAMOUFLAGE] =
    {
        ...
        .secondaryId = TYPE_NATURE,
        .flingPower = 30,
        .iconPic = gItemIcon_Camouflage,
        .iconPalette = gItemIconPalette_Camouflage,
    },

    [ITEM_THICK_FUR] =
    {
        .name = ITEM_NAME("Thick Fur"),
        .pluralName = ITEM_PLURAL_NAME("Thick Fur"),
        .price = TYPE_BOOSTING_PRICE,
        .holdEffect = HOLD_EFFECT_TYPE_POWER,
        .holdEffectParam = TYPE_BOOST_PARAM,
        .description = COMPOUND_STRING(
        ...
        .secondaryId = TYPE_ICE,
        .flingPower = 30,
        .iconPic = gItemIcon_ThickFur,
        .iconPalette = gItemIconPalette_ThickFur,
    },

    [ITEM_CHINESE_DRESS] =
    {
        .name = ITEM_NAME("Chinese Dress"),
        .pluralName = ITEM_PLURAL_NAME("Chinese Dresses"),
        .price = TYPE_BOOSTING_PRICE,
        .holdEffect = HOLD_EFFECT_TYPE_POWER,
        .holdEffectParam = TYPE_BOOST_PARAM,
        .description = COMPOUND_STRING(
        ...
        .secondaryId = TYPE_DREAM,
        .flingPower = 30,
        .iconPic = gItemIcon_ChinaDress,
        .iconPalette = gItemIconPalette_ChinaDress,
    },

    [ITEM_NURSE_UNIFORM] =
    {
        .name = ITEM_NAME("Nurse Uniform"),
        .price = TYPE_BOOSTING_PRICE,
        .holdEffect = HOLD_EFFECT_TYPE_POWER,
        .holdEffectParam = TYPE_BOOST_PARAM,
        .description = COMPOUND_STRING(
        ...
        .secondaryId = TYPE_MIASMA,
        .flingPower = 70,
        .iconPic = gItemIcon_NurseOutfit,
        .iconPalette = gItemIconPalette_NurseOutfit,
    },
    ...
    [ITEM_GYM_SUIT] =
    {
        ...
        .secondaryId = TYPE_EARTH,
        .flingPower = 10,
        .iconPic = gItemIcon_GymSuit,
        .iconPalette = gItemIconPalette_GymSuit,
    },

    [ITEM_STEWARDESS] =
    {
        .name = ITEM_NAME("Stewardess"),
        .pluralName = ITEM_PLURAL_NAME("Stewardesses"),
        .price = TYPE_BOOSTING_PRICE,
        .holdEffect = HOLD_EFFECT_TYPE_POWER,
        .holdEffectParam = TYPE_BOOST_PARAM,
        .description = COMPOUND_STRING(
        ...
        .secondaryId = TYPE_FLYING,
        .flingPower = 50,
        .iconPic = gItemIcon_Stewardess,
        .iconPalette = gItemIconPalette_Stewardess,
    },

    [ITEM_WITCHS_ROBE] =
    {
        .name = ITEM_NAME("Witch's Robe"),
        .price = TYPE_BOOSTING_PRICE,
        .holdEffect = HOLD_EFFECT_TYPE_POWER,
        .holdEffectParam = TYPE_BOOST_PARAM,
        .description = COMPOUND_STRING(
        ...
        .secondaryId = TYPE_REASON,
        .flingPower = 30,
        .iconPic = gItemIcon_WitchsRobe,
        .iconPalette = gItemIconPalette_WitchsRobe,
    },
    ...
    [ITEM_BLAZER] =
    {
        ...
        .secondaryId = TYPE_HEART,
        .flingPower = 10,
        .iconPic = gItemIcon_Blazer,
        .iconPalette = gItemIconPalette_Blazer,
    },
    ...
    [ITEM_BUNNY_SUIT] =
    {
        ...
        .secondaryId = TYPE_BEAST,
        .flingPower = 100,
        .iconPic = gItemIcon_BunnySuit,
        .iconPalette = gItemIconPalette_BunnySuit,
    },

    [ITEM_BURIAL_DRESS] =
    {
        .name = ITEM_NAME("Burial Dress"),
        .pluralName = ITEM_PLURAL_NAME("Burial Dresses"),
        .price = TYPE_BOOSTING_PRICE,
        .holdEffect = HOLD_EFFECT_TYPE_POWER,
        .holdEffectParam = TYPE_BOOST_PARAM,
        .description = COMPOUND_STRING(
        ...
        .secondaryId = TYPE_GHOST,
        .flingPower = 30,
        .iconPic = gItemIcon_BurialDress,
        .iconPalette = gItemIconPalette_BurialDress,
    },

    [ITEM_PRIESTESS] =
    {
        .name = ITEM_NAME("Priestess"),
        .pluralName = ITEM_PLURAL_NAME("Priestesses"),
        .price = TYPE_BOOSTING_PRICE,
        .holdEffect = HOLD_EFFECT_TYPE_POWER,
        .holdEffectParam = TYPE_BOOST_PARAM,
        .description = COMPOUND_STRING(
        ...
        .secondaryId = TYPE_FAITH,
        .flingPower = 70,
        .iconPic = gItemIcon_Priestess,
        .iconPalette = gItemIconPalette_Priestess,
    },
...
// Misc. Held Items
    ...
    [ITEM_DONATION_BOX] =
    {
        .name = ITEM_NAME("Donation Box"),
        .pluralName = ITEM_PLURAL_NAME("Donation Boxes"),
    #if I_PRICE >= GEN_9
        .price = 30000,
    #elif I_PRICE >= GEN_7
        .price = 10000,
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
        .iconPic = gItemIcon_DonationBox,
        .iconPalette = gItemIconPalette_DonationBox,
    },
...
// Berries
    ...
    [ITEM_RINDO_BERRY] =
    {
        ...
        .descriptionLong = COMPOUND_STRING(
            "If held, reduces damage taken from\n"
            "one super effective Nature move."),
        .pocket = POCKET_BERRIES,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
    ...
    [ITEM_CHOPLE_BERRY] =
    {
        ...
        .descriptionLong = COMPOUND_STRING(
            "If held, reduces damage taken from\n"
            "one super effective Dream move."),
        .pocket = POCKET_BERRIES,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
    ...
    [ITEM_KEBIA_BERRY] =
    {
        ...
        .descriptionLong = COMPOUND_STRING(
            "If held, reduces damage taken from\n"
            "one super effective Miasma move."),
        .pocket = POCKET_BERRIES,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
    ...
    [ITEM_SHUCA_BERRY] =
    {
        ...
        .descriptionLong = COMPOUND_STRING(
            "If held, reduces damage taken from\n"
            "one super effective Earth move."),
        .pocket = POCKET_BERRIES,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
    ...
    [ITEM_PAYAPA_BERRY] =
    {
        ...
        .descriptionLong = COMPOUND_STRING(
            "If held, reduces damage taken from\n"
            "one super effective Reason move."),
        .pocket = POCKET_BERRIES,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
    ...
    [ITEM_TANGA_BERRY] =
    {
        ...
        .descriptionLong = COMPOUND_STRING(
            "If held, reduces damage taken from\n"
            "one super effective Heart move."),
        .pocket = POCKET_BERRIES,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
    ...
    [ITEM_CHARTI_BERRY] =
    {
        ...
        .descriptionLong = COMPOUND_STRING(
            "If held, reduces damage taken from\n"
            "one super effective Beast move."),
        .pocket = POCKET_BERRIES,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
    ...
    [ITEM_HABAN_BERRY] =
    {
        ...
        .descriptionLong = COMPOUND_STRING(
            "If held, reduces damage taken from\n"
            "one super effective Faith move."),
        .pocket = POCKET_BERRIES,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
    ...
    [ITEM_ROSELI_BERRY] =
    {
        ...
        .descriptionLong = COMPOUND_STRING(
            "If held, reduces damage taken from\n"
            "one super effective Cosmic move."),
        .pocket = POCKET_BERRIES,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
    ...
    [ITEM_STARF_BERRY] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "stat in a pinch."),
        .descriptionLong = COMPOUND_STRING(
            "When held by a Puppet, it sharply\n"
    ...
    [ITEM_TURLAN_BERRY] =
    {
        .name = ITEM_NAME("Turlan Berry"),
        .pluralName = ITEM_PLURAL_NAME("Turlan Berries"),
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 20,
        .description = COMPOUND_STRING(
            "{POKEBLOCK} ingredient.\n"
            "Plant in loamy soil\n"
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
        .iconPic = gItemIcon_TurlanBerry,
        .iconPalette = gItemIconPalette_TurlanBerry,
    },
    ...
    [ITEM_IONNO_BERRY] =
    {
        .name = ITEM_NAME("Ionno Berry"),
        .pluralName = ITEM_PLURAL_NAME("Ionno Berries"),
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 20,
        .holdEffect = HOLD_EFFECT_WHITE_HERB,
        .description = COMPOUND_STRING(
            "A berry that\n"
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
        .iconPic = gItemIcon_IonnoBerry,
        .iconPalette = gItemIconPalette_IonnoBerry,
    },

    [ITEM_KUO_BERRY] =
    {
        .name = ITEM_NAME("Kuo Berry"),
        .pluralName = ITEM_PLURAL_NAME("Kuo Berries"),
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 20,
        .description = COMPOUND_STRING(
            "{POKEBLOCK} ingredient.\n"
            "Plant in loamy soil\n"
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
        .iconPic = gItemIcon_KuoBerry,
        .iconPalette = gItemIconPalette_KuoBerry,
    },

    [ITEM_YAGO_BERRY] =
    {
        .name = ITEM_NAME("Yago Berry"),
        .pluralName = ITEM_PLURAL_NAME("Yago Berries"),
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 20,
        .holdEffect = HOLD_EFFECT_CURE_BRN,
        .description = COMPOUND_STRING(
            "A berry that\n"
        ...
        .effect = gItemEffect_BurnHeal,
        .flingPower = 10,
        .iconPic = gItemIcon_YagoBerry,
        .iconPalette = gItemIconPalette_YagoBerry,
    },
    ...
    [ITEM_GARLIG_BERRY] =
    {
        .name = ITEM_NAME("Garlig Berry"),
        .pluralName = ITEM_PLURAL_NAME("Garlig Berries"),
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 20,
        .description = COMPOUND_STRING(
            "{POKEBLOCK} ingredient.\n"
            "Plant in loamy soil\n"
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
        .iconPic = gItemIcon_GarligBerry,
        .iconPalette = gItemIconPalette_GarligBerry,
    },
...
// GEN 9 ITEMS
    ...
    [ITEM_BUG_TERA_SHARD] =
    {
        .name = ITEM_NAME("Heart Tera Shard"),
        .price = 0,
    ...
    {
        .name = ITEM_NAME("Faith Tera Shard"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    {
        .name = ITEM_NAME("Wind Tera Shard"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    {
        .name = ITEM_NAME("Dream Tera Shard"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    {
        .name = ITEM_NAME("Nature Tera Shard"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    {
        .name = ITEM_NAME("Earth Tera Shard"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    {
        .name = ITEM_NAME("Illusion Tera Shard"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    {
        .name = ITEM_NAME("Miasma Tera Shard"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    {
        .name = ITEM_NAME("Reason Tera Shard"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    {
        .name = ITEM_NAME("Beast Tera Shard"),
        .price = 0,
        .description = sTeraShardDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_TERA_SHARD,
    ...
    [ITEM_MUSIC_PLAYER] =
    {
        ...
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
        .fieldUseFunc = ItemUseOutOfBattle_MusicPlayer,
        .iconPic = gItemIcon_QuestionMark,
        .iconPalette = gItemIconPalette_QuestionMark,
    },
