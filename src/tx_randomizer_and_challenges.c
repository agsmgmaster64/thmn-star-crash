...
const u8 NuzlockeLUT[] =
{
    ...
    [MAPSEC_MT_PYRE] = 0x33,
    //7
    [MAPSEC_SHOAL_CAVE] = 0x34,
    [MAPSEC_AQUA_HIDEOUT] = 0x35,
    [MAPSEC_MAGMA_HIDEOUT] = 0x36,
    [MAPSEC_SEAFLOOR_CAVERN] = 0x37,
    [MAPSEC_CAVE_OF_ORIGIN] = 0x38,
    [MAPSEC_SKY_PILLAR] = 0x39,
    [MAPSEC_VICTORY_ROAD] = 0x3A,
    [MAPSEC_UNDERWATER_124] = 0x3B,
    //8
