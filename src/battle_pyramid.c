...
static const u16 sPickupItemsLvl50[TOTAL_PYRAMID_ROUNDS][PICKUP_ITEMS_PER_ROUND] =
{
    ...
    {ITEM_HYPER_POTION, ITEM_DIRE_HIT, ITEM_PECHA_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_BENTO_BOX, ITEM_CHOICE_RIBBON, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    ...
    {ITEM_HYPER_POTION, ITEM_X_ACCURACY, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_BENTO_BOX, ITEM_CHOICE_RIBBON, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    ...
    {ITEM_HYPER_POTION, ITEM_DIRE_HIT, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_BENTO_BOX, ITEM_CHOICE_RIBBON, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
...
static const u16 sLongStreakRewardItems[] = {ITEM_BRIGHT_POWDER, ITEM_WHITE_HERB, ITEM_QUICK_CLAW, ITEM_BENTO_BOX, ITEM_MENTAL_HERB, ITEM_KINGS_ROCK, ITEM_FOCUS_BAND, ITEM_SCOPE_LENS, ITEM_CHOICE_RIBBON};
