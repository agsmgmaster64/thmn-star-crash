...
#define GRASS_STARTER (IS_FRLG ? SPECIES_CHIBI_SARA  : SPECIES_CHIBI_SARA)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHIBI_LOUISE   : SPECIES_CHIBI_LOUISE)
#define WATER_STARTER (IS_FRLG ? SPECIES_CHIBI_KURUMI : SPECIES_CHIBI_KURUMI )
