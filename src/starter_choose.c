...
#define GRASS_STARTER (IS_FRLG ? SPECIES_CHIBI_SANAE  : SPECIES_CHIBI_SARA)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHIBI_REISEN   : SPECIES_CHIBI_LOUISE)
#define WATER_STARTER (IS_FRLG ? SPECIES_CHIBI_ALICE : SPECIES_CHIBI_KURUMI )
