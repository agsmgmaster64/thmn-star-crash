...
const struct PokeBallSprite gPokeBalls[POKEBALL_COUNT] =
{
    ...
    [BALL_POKE2]    =
    {
        POKE_BALL_SPRITE(GFX_TAG_POKE_BALL2, gBallGfx_PokeHisui, gBallPal_PokeHisui),
        .itemId = ITEM_POKE_BALL_HISUI,
    },

    [BALL_GREAT2]   =
    {
        POKE_BALL_SPRITE(GFX_TAG_GREAT_BALL2, gBallGfx_GreatHisui, gBallPal_GreatHisui),
        .itemId = ITEM_GREAT_BALL_HISUI,
    },

    [BALL_ULTRA2]   =
    {
        POKE_BALL_SPRITE(GFX_TAG_ULTRA_BALL2, gBallGfx_UltraHisui, gBallPal_UltraHisui),
        .itemId = ITEM_ULTRA_BALL_HISUI,
    },
};
