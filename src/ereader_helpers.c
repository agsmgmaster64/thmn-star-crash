    ...
    [2] = {
        ...
        .mons = {
            ...
            [3] = {
                ...
                .moves = { MOVE_SING, MOVE_BODY_SLAM, MOVE_SHADOW_BALL, MOVE_STEEL_FIST },
                .hpEV = 0,
                .attackEV = 255,
                .defenseEV = 0,
                .speedEV = 255,
    ...
    [3] = {
        ...
        .mons = {
            ...
            [5] = {
                ...
                .heldItem = ITEM_LUM_BERRY,
                .moves = { MOVE_MANA_BURST, MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_WILL_O_WISP },
                .hpEV = 255,
                .attackEV = 0,
                .defenseEV = 0,
                .speedEV = 0,
