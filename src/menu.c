...
{   // { width, height, offset }
    ...
    [MENU_INFO_ICON_EFFECT]    = { 42, 12, 0xE8 },
    [MENU_INFO_ICON_CATEGORY]  = { 42, 12, 0x100 },
    [MENU_INFO_ICON_PHYSICAL]  = { 24, 12, 0x4 },
    [MENU_INFO_ICON_SPECIAL]   = { 24, 12, 0x8 },
    [MENU_INFO_ICON_STATUS]    = { 24, 12, 0xC },
...
static void WindowFunc_RedrawDialogueFrame(u8 bg, u8 left, u8 top, u8 width, u8 height, u8 paletteNum)
{
    ...
    FillMenuTilemapBufferRect(bg,  2, left - 1,         top - 1,         1, 1);
    FillMenuTilemapBufferRect(bg,  3, left,             top - 1, width - 1, 1);
    FillMenuTilemapBufferRect(bg,  4, left + width - 1, top - 1,         1, 1);
    FillMenuTilemapBufferRect(bg,  5, left + width,     top - 1,         1, 1);
}
...
static void WindowFunc_DrawDialogueFrame(u8 bg, u8 left, u8 top, u8 width, u8 height, u8 paletteNum)
{
    ...
    FillMenuTilemapBufferRect(bg, BG_TILE_V_FLIP(2), left - 1,         top + height,         1, 1);
    FillMenuTilemapBufferRect(bg, BG_TILE_V_FLIP(3), left,             top + height, width - 1, 1);
    FillMenuTilemapBufferRect(bg, BG_TILE_V_FLIP(4), left + width - 1, top + height,         1, 1);
    FillMenuTilemapBufferRect(bg, BG_TILE_V_FLIP(5), left + width,     top + height,         1, 1);
}
