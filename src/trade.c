...
static void CB2_InitInGameTrade(void)
{
    ...
    case 0:
        ...
        ConvertInternationalString(otName, GetMonData(&gParties[B_TRAINER_OPPONENT_A][0], MON_DATA_LANGUAGE));
