...
static const u8 sTrainerCardTextColors[] = {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_LIGHT_GRAY, TEXT_DYNAMIC_COLOR_1};
...
static void CreateTrainerCardTrainerPic(void)
{
    ...
    else
    {
        ...
        u16 picId = GetPlayerTrainerPicIdByOutfitGenderType(gSaveBlock3Ptr->currOutfitId, sData->trainerCard.gender, 0);
