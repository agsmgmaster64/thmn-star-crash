...
const u8 gText_Puppet[POKEMON_NAME_LENGTH + 1] = _("Puppet");
...
const u8 gText_ListByBodyColor[] = _("List by source.\nSpotted Puppets only.");
...
const u8 gText_DexSearchSourceTouhou1[] = _("HRtP");
const u8 gText_DexSearchSourceTouhou2[] = _("SeOW");
const u8 gText_DexSearchSourceTouhou3[] = _("PoDD");
const u8 gText_DexSearchSourceTouhou4[] = _("LLS");
const u8 gText_DexSearchSourceTouhou5[] = _("MS");
const u8 gText_DexSearchSourceTouhou6[] = _("EoSD");
const u8 gText_DexSearchSourceTouhou7[] = _("PCB");
const u8 gText_DexSearchSourceTouhou8[] = _("IN");
const u8 gText_DexSearchSourceTouhou9[] = _("PoFV");
const u8 gText_DexSearchSourceTouhou10[] = _("MoF");
const u8 gText_DexSearchSourceTouhou11[] = _("SA");
const u8 gText_DexSearchSourceTouhou12[] = _("UFO");
const u8 gText_DexSearchSourceTouhou13[] = _("TD");
const u8 gText_DexSearchSourceTouhou14[] = _("DDC");
const u8 gText_DexSearchSourceTouhou15[] = _("LoLK");
const u8 gText_DexSearchSourceTouhou16[] = _("HSiFS");
const u8 gText_DexSearchSourceTouhou17[] = _("WBaBC");
const u8 gText_DexSearchSourceTouhou18[] = _("UM");
const u8 gText_DexSearchSourceTouhou19[] = _("UDoALG");
const u8 gText_DexSearchSourceTouhouSpinoff[] = _("Spinoff");
const u8 gText_DexSearchSourceTouhouPrint[] = _("Print");
const u8 gText_DexSearchSourceVTubers[] = _("VTubers");
...
const u8 gText_DexSearchSourceMario[] = _("Mario");
const u8 gText_DexSearchSourceMisc[] = _("Misc.");
...
const u8 gText_DexOtherDescription[] = _("Original characters from fan works,\ninternet memes, or other such sources.");
...
const u8 gText_HOFDexRating[] = _("Spotted Puppets: {STR_VAR_1}!\nOwned Puppets: {STR_VAR_2}!\pProf. Birch's iDollDex rating!\pProf. Birch: Let's see…\p");
...
const u8 gText_YinSymbol[] = _("{YIN}");
const u8 gText_YangSymbol[] = _("{YANG}");
...
const u8 gText_Var1sVar2And[] = _("{STR_VAR_1}'s\n{STR_VAR_2} and\l");
const u8 gText_Var1sVar2WereSwapped[] = _("{STR_VAR_1}'s\l{STR_VAR_2} were swapped!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThePokemonList[] = _("the Puppets List");
const u8 gText_TheShop[] = _("the shop");
const u8 gText_ThePC[] = _("the PC");
const u8 gText_ReelItIn[] = _("Hold and release A to keep the\nPuppet inside the fishing bar!");
...
const u8 gText_ReeledInAPokemon[] = _("{PLAYER} reeled in a Puppet!{PAUSE_UNTIL_PRESS}");
const u8 gText_PokemonGotAway[] = _("Oh, no!\nThe Puppet got away…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Var1AndYouWantedVar2_Coins[] = _("{STR_VAR_1}? And you wanted {STR_VAR_2}?\nThat will be {STR_VAR_3} Coins.");
const u8 gText_YouWantedVar1ThatllBeVar2[] = _("You wanted {STR_VAR_1}?\nThat'll be ¥{STR_VAR_2}. Will that be okay?");
const u8 gText_YouWantedVar1ThatllBeVar2_Coins[] = _("You wanted {STR_VAR_1}?\nThat'll be {STR_VAR_2} Coins. Will that be okay?");
...
const u8 gText_YouDontHaveCoins[] = _("You don't have enough Coins.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} Puppets\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnCantRelearnMoves[] = _("{STR_VAR_1} is unable to\nrelearn any moves.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_DoWhatWithPokemon[] = _("Do what with Puppet?");
...
const u8 gText_NoPokemonForBattle[] = _("No Puppets for battle!");
...
const u8 gText_RentalPkmn[] = _("Rental Puppet");
const u8 gText_TypeSlash[] = _("Type/");
const u8 gText_Power[] = _("Power");
const u8 gText_Accuracy2[] = _("Accuracy");
const u8 gText_Accuracy3[] = _("Acc.");
const u8 gText_PPDex[] = _("PP");
...
const u8 gText_Gura[] = _("Gura");
const u8 gText_Ina[] = _("Ina");
const u8 gText_Kiara[] = _("Kiara");
const u8 gText_Calli[] = _("Calli");
const u8 gText_Kronii[] = _("Kronii");
const u8 gText_Baelz[] = _("Baelz");
const u8 gText_Mumei[] = _("Mumei");
const u8 gText_Fauna[] = _("Fauna");
const u8 gText_Sana[] = _("Sana");
const u8 gText_IRyS[] = _("IRyS");
const u8 gText_Shiori[] = _("Shiori");
const u8 gText_Bijou[] = _("Bijou");
const u8 gText_Nerissa[] = _("Nerissa");
const u8 gText_Fuwawa[] = _("Fuwawa");
const u8 gText_Mococo[] = _("Mococo");
const u8 gText_FuwaMoco[] = _("FuwaMoco");
const u8 gText_Gigi[] = _("Gigi");
const u8 gText_Cecilia[] = _("Cecilia");
const u8 gText_Elizabeth[] = _("Elizabeth");
const u8 gText_Raora[] = _("Raora");
const u8 gText_Maddie[] = _("Madison");
const u8 gText_Cyan[] = _("Teal");
...
const u8 gText_MenuOptionPokemon[] = _("Puppets");
...
const u8 gText_HealthboxGender_Yin[] = _("{COLOR DYNAMIC_COLOR2}{YIN}");
const u8 gText_HealthboxGender_Yang[] = _("{COLOR DYNAMIC_COLOR1}{YANG}");
...
const u8 gText_MenuPokemon[] = _("Puppets");
...
const u8 gText_MenuExitLeft[] = _("Exit {DPAD_LEFT}");
const u8 gText_MenuExitRight[] = _("Exit {DPAD_RIGHT}");
...
const u8 gText_RentalPkmn2[] = _("Rental Puppet");
...
const u8 gText_MoveRelearnerContinue[] = _("Continue trying to teach a new\nmove to {STR_VAR_1}?");
