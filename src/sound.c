...
static const struct Fanfare sFanfares[] = {
    ...
    [FANFARE_EVOLVED]             = { MUS_ZGS_EVOLVED,         220 },
    [FANFARE_OBTAIN_TMHM]         = { MUS_OBTAIN_TMHM,         220 },
    [FANFARE_HEAL]                = { MUS_ZGS_HEAL,            160 },
    [FANFARE_OBTAIN_BADGE]        = { MUS_OBTAIN_BADGE,        340 },
    [FANFARE_MOVE_DELETED]        = { MUS_ZGS_MOVE_DELETED,    180 },
    ...
    [FANFARE_RG_POKE_FLUTE]       = { MUS_ZGS_POKE_FLUTE,      450 },
