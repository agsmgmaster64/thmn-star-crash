			...
			.mons = {
				{
					...
					.moves = {MOVE_SHOCK_WAVE, MOVE_KILLING_BITE, MOVE_SCARY_FACE, MOVE_ENDEAVOR},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 200,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_GIGA_DRAIN, MOVE_CONFUSE_RAY, MOVE_POISON_BOMB, MOVE_CHARMING_LOOK},
					.hpEV = 0,
					.attackEV = 200,
					.defenseEV = 0,
					.speedEV = 110,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_SUNNY_DAY, MOVE_YAWN, MOVE_FLAMETHROWER, MOVE_PSYSHOT},
					.hpEV = 100,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 0,
			...
			.mons = {
				{
					...
					.moves = {MOVE_LIGHT_SCREEN, MOVE_MIND_BOMB, MOVE_MINIMIZE, MOVE_SECRET_POWER},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_ORAN_BERRY,
					.moves = {MOVE_METRONOME, MOVE_MULTI_PULSE, MOVE_ATTRACT, MOVE_LIGHT_SCREEN},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.moves = {MOVE_GRUDGE, MOVE_MANA_BURST, MOVE_SHADOW_BALL, MOVE_THUNDERBOLT},
					.hpEV = 200,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 210,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BENTO_BOX,
					.moves = {MOVE_LIGHT_SCREEN, MOVE_RECOVER, MOVE_MANA_BURST, MOVE_THUNDER_PUNCH},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BENTO_BOX,
					.moves = {MOVE_LIGHT_SCREEN, MOVE_ATTRACT, MOVE_RETURN, MOVE_MANA_BURST},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BENTO_BOX,
					.moves = {MOVE_EXPLOSION, MOVE_SMOKESCREEN, MOVE_POISON_BOMB, MOVE_THUNDERBOLT},
					.hpEV = 100,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SHELL_BELL,
					.moves = {MOVE_HEAT_CLAW, MOVE_QUICK_ATTACK, MOVE_SWAGGER, MOVE_ENDEAVOR},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_FIRE_PUNCH, MOVE_RECOVER, MOVE_MANA_BURST, MOVE_SUNNY_DAY},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_SUNNY_DAY, MOVE_DRILL_PECK, MOVE_CONFUSE_RAY, MOVE_MANA_BURST},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 100,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_REFLECT, MOVE_SUNNY_DAY, MOVE_MANA_BURST, MOVE_SHOCK_WAVE},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 200,
					.speedEV = 200,
			...
			.mons = {
				{
					...
					.moves = {MOVE_FIRE_PUNCH, MOVE_HYPNOSIS, MOVE_MANA_BURST, MOVE_NIGHTMARE},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_MAGIC_POWDER, MOVE_EARTHQUAKE, MOVE_COUNTER, MOVE_LEER},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 200,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LAX_INCENSE,
					.moves = {MOVE_SING, MOVE_MULTI_PULSE, MOVE_CHARM, MOVE_DOUBLE_TEAM},
					.hpEV = 210,
					.attackEV = 0,
					.defenseEV = 45,
					.speedEV = 210,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LAX_INCENSE,
					.moves = {MOVE_FAKE_TEARS, MOVE_MANA_BURST, MOVE_CHARMING_LOOK, MOVE_SING},
					.hpEV = 210,
					.attackEV = 0,
					.defenseEV = 45,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_CHARMING_LOOK, MOVE_PERISH_SONG, MOVE_TOXIC, MOVE_FLASH},
					.hpEV = 90,
					.attackEV = 0,
					.defenseEV = 210,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SCOPE_LENS,
					.moves = {MOVE_HEART_BREAK, MOVE_METAL_CLAW, MOVE_AERIAL_ACE, MOVE_OUTRAGE},
					.hpEV = 200,
					.attackEV = 200,
					.defenseEV = 0,
					.speedEV = 110,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SCOPE_LENS,
					.moves = {MOVE_MAGIC_POWDER, MOVE_SCULPTURE, MOVE_CRUSH_CLAW, MOVE_BRICK_BREAK},
					.hpEV = 100,
					.attackEV = 210,
					.defenseEV = 200,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SCOPE_LENS,
					.moves = {MOVE_EXTREME_SPEED, MOVE_STEEL_FIST, MOVE_AERIAL_ACE, MOVE_DIG},
					.hpEV = 110,
					.attackEV = 200,
					.defenseEV = 0,
					.speedEV = 200,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SCOPE_LENS,
					.moves = {MOVE_DOUBLE_EDGE, MOVE_TREMORS, MOVE_BRICK_BREAK, MOVE_DIG},
					.hpEV = 100,
					.attackEV = 210,
					.defenseEV = 200,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIDAL_GOWN,
					.moves = {MOVE_OUTRAGE, MOVE_STEEL_FIST, MOVE_DOUBLE_EDGE, MOVE_SLAM},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIDAL_GOWN,
					.moves = {MOVE_BOUNCE, MOVE_STEEL_FIST, MOVE_THRASH, MOVE_DOUBLE_EDGE},
					.hpEV = 110,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 100,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIDAL_GOWN,
					.moves = {MOVE_STEEL_FIST, MOVE_FLAIL, MOVE_BITE, MOVE_DOUBLE_EDGE},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIDAL_GOWN,
					.moves = {MOVE_RETURN, MOVE_AERIAL_ACE, MOVE_STEEL_FIST, MOVE_DIG},
					.hpEV = 110,
					.attackEV = 200,
					.defenseEV = 0,
					.speedEV = 200,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_KINGS_ROCK,
					.moves = {MOVE_FIRE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_BRICK_BREAK, MOVE_STEEL_FIST},
					.hpEV = 110,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 100,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_KINGS_ROCK,
					.moves = {MOVE_THRASH, MOVE_CROSS_CHOP, MOVE_STEEL_FIST, MOVE_AERIAL_ACE},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 200,
					.speedEV = 110,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.moves = {MOVE_AMNESIA, MOVE_MANA_BURST, MOVE_SURF, MOVE_ICE_BEAM},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
				...
				},
				{
					...
					.moves = {MOVE_STEEL_FIST, MOVE_POISON_BOMB, MOVE_ROCK_SLIDE, MOVE_TOXIC},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
				...
				},
				{
					...
					.moves = {MOVE_EARTHQUAKE, MOVE_MAGIC_POWDER, MOVE_POISON_BOMB, MOVE_ROCK_SLIDE},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIDAL_GOWN,
					.moves = {MOVE_CHARM, MOVE_TREMORS, MOVE_RETURN, MOVE_REST},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_SILVER_WIND, MOVE_SLEEP_POWDER, MOVE_MANA_BURST, MOVE_JAMMING},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_POISON_BOMB, MOVE_SEAL_NEEDLE, MOVE_DOUBLE_TEAM, MOVE_AERIAL_ACE},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SHELL_BELL,
					.moves = {MOVE_MAGIC_POWDER, MOVE_ROCK_BLAST, MOVE_BRICK_BREAK, MOVE_PROTECT},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_MAGIC_POWDER, MOVE_BRICK_BREAK, MOVE_ROCK_TOMB, MOVE_PROTECT},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SHELL_BELL,
					.moves = {MOVE_BRICK_BREAK, MOVE_BADDY_BAD, MOVE_AERIAL_ACE, MOVE_PROTECT},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_QUICK_ATTACK, MOVE_MANA_BURST, MOVE_SHADOW_BALL, MOVE_BITE},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_QUICK_ATTACK, MOVE_FLAMETHROWER, MOVE_SHADOW_BALL, MOVE_STEEL_FIST},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_QUICK_ATTACK, MOVE_DOUBLE_EDGE, MOVE_BITE, MOVE_STEEL_FIST},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_QUICK_ATTACK, MOVE_FAINT_ATTACK, MOVE_SHADOW_BALL, MOVE_STEEL_FIST},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_HELPING_HAND, MOVE_MANA_BURST},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_GYM_SUIT,
					.moves = {MOVE_EARTHQUAKE, MOVE_MAGIC_POWDER, MOVE_SHADOW_BALL, MOVE_FIRE_BLAST},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_GYM_SUIT,
					.moves = {MOVE_EARTHQUAKE, MOVE_QUICK_ATTACK, MOVE_AERIAL_ACE, MOVE_STEEL_FIST},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_GYM_SUIT,
					.moves = {MOVE_EARTHQUAKE, MOVE_POISON_BOMB, MOVE_BLIZZARD, MOVE_BRICK_BREAK},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_GYM_SUIT,
					.moves = {MOVE_EARTHQUAKE, MOVE_STEEL_FIST, MOVE_DECISION, MOVE_DOUBLE_EDGE},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 255,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_KINGS_ROCK,
					.moves = {MOVE_SHADOW_BALL, MOVE_POISON_BOMB, MOVE_THUNDERBOLT, MOVE_MANA_BURST},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_MANA_BURST, MOVE_CONFUSE_RAY, MOVE_AERIAL_ACE, MOVE_LIGHT_SCREEN},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_PETAYA_BERRY,
					.moves = {MOVE_INGRAIN, MOVE_GIGA_DRAIN, MOVE_POISON_BOMB, MOVE_STUN_SPORE},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_PETAYA_BERRY,
					.moves = {MOVE_MANA_BURST, MOVE_ICE_BEAM, MOVE_WATERFALL, MOVE_RECOVER},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_GIGA_DRAIN, MOVE_POISON_BOMB, MOVE_REFLECT, MOVE_ATTRACT},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_EARTHQUAKE, MOVE_ANCIENT_POWER, MOVE_STEEL_FIST, MOVE_DOUBLE_EDGE},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_MANA_BURST, MOVE_POISON_BOMB, MOVE_SIGNAL_BEAM, MOVE_TOXIC},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 255,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_TWISTER, MOVE_BLACK_RIPPLE, MOVE_AURORA_BEAM, MOVE_RETURN},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_THUNDER, MOVE_FIRE_BLAST, MOVE_BLIZZARD, MOVE_HEART_BREAK},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.moves = {MOVE_EARTHQUAKE, MOVE_SUPERPOWER, MOVE_POISON_BOMB, MOVE_ROCK_SLIDE},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
			...
			.mons = {
				{
					...
					.moves = {MOVE_NATURE_POWER, MOVE_ATTRACT, MOVE_PETAL_DANCE, MOVE_FLAIL},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
				...
				},
				{
					...
					.moves = {MOVE_NATURE_POWER, MOVE_ATTRACT, MOVE_GIGA_DRAIN, MOVE_POISON_BOMB},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CAMOUFLAGE,
					.moves = {MOVE_NATURE_POWER, MOVE_ATTRACT, MOVE_GIGA_DRAIN, MOVE_AERIAL_ACE},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_PERSIM_BERRY,
					.moves = {MOVE_NATURE_POWER, MOVE_ATTRACT, MOVE_PETAL_DANCE, MOVE_POISON_BOMB},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CAMOUFLAGE,
					.moves = {MOVE_NATURE_POWER, MOVE_ATTRACT, MOVE_GIGA_DRAIN, MOVE_BODY_SLAM},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_EARTHQUAKE, MOVE_BRICK_BREAK, MOVE_BADDY_BAD, MOVE_AERIAL_ACE},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_SURF, MOVE_BLIZZARD, MOVE_MANA_BURST, MOVE_THUNDER},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_THUNDERBOLT, MOVE_QUICK_ATTACK, MOVE_DOUBLE_TEAM, MOVE_STEEL_FIST},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_ANCIENT_POWER, MOVE_SWEET_KISS, MOVE_MANA_BURST, MOVE_MAGICAL_LEAF},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_SURF, MOVE_PSYSHOT, MOVE_AMNESIA, MOVE_DISABLE},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_NURSE_UNIFORM,
					.moves = {MOVE_SURF, MOVE_POISON_BOMB, MOVE_ICE_BEAM, MOVE_MIRROR_COAT},
					.hpEV = 100,
					.attackEV = 0,
					.defenseEV = 110,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_HEAT_CLAW, MOVE_KILLING_BITE, MOVE_THUNDER_WAVE, MOVE_QUICK_ATTACK},
					.hpEV = 110,
					.attackEV = 200,
					.defenseEV = 100,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_SURF, MOVE_MANA_BURST, MOVE_THUNDER_WAVE, MOVE_RECOVER},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHESTO_BERRY,
					.moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_DECISION, MOVE_REST},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BENTO_BOX,
					.moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_MANA_BURST, MOVE_ATTRACT},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_SURF, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_HEART_BREAK},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LIECHI_BERRY,
					.moves = {MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_SHADOW_BALL, MOVE_POISON_BOMB},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 130,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_DIVE, MOVE_LEER, MOVE_TICKLE, MOVE_JAMMING},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_KINGS_ROCK,
					.moves = {MOVE_DIG, MOVE_AMNESIA, MOVE_DEFENSE_CURL, MOVE_GUARD},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_DIVE, MOVE_WITHDRAW, MOVE_PROTECT, MOVE_JAMMING},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_WATER_PULSE, MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_MANA_BURST},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 155,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_LIGHT_SCREEN, MOVE_CRUNCH, MOVE_MANA_BURST, MOVE_REFLECT},
					.hpEV = 210,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BENTO_BOX,
					.moves = {MOVE_SURF, MOVE_MANA_BURST, MOVE_ICE_BEAM, MOVE_SHADOW_BALL},
					.hpEV = 0,
					.attackEV = 110,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_MANA_BURST, MOVE_PROTECT, MOVE_LIGHT_SCREEN, MOVE_REFLECT},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 200,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_SURF, MOVE_MAGIC_POWDER, MOVE_THUNDERBOLT, MOVE_ICE_BEAM},
					.hpEV = 110,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_EARTHQUAKE, MOVE_PROTECT, MOVE_MAGIC_POWDER, MOVE_ROCK_SLIDE},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_NURSE_UNIFORM,
					.moves = {MOVE_WATER_PULSE, MOVE_POISON_BOMB, MOVE_CRUNCH, MOVE_DIG},
					.hpEV = 110,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_WATER_PULSE, MOVE_POISON_BOMB, MOVE_SCULPTURE, MOVE_DIG},
					.hpEV = 110,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_WATER_PULSE, MOVE_MAGIC_POWDER, MOVE_JAMMING, MOVE_ICE_BEAM},
					.hpEV = 110,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SCOPE_LENS,
					.moves = {MOVE_SURF, MOVE_MAGIC_POWDER, MOVE_SCULPTURE, MOVE_PROTECT},
					.hpEV = 100,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_BLACK_RIPPLE, MOVE_ICE_BEAM, MOVE_MANA_BURST, MOVE_FLAMETHROWER},
					.hpEV = 55,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_PECHA_BERRY,
					.moves = {MOVE_SURF, MOVE_MANA_BURST, MOVE_ICE_BEAM, MOVE_THUNDER_WAVE},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_BLACK_RIPPLE, MOVE_POISON_BOMB, MOVE_THUNDER_WAVE, MOVE_HYPER_BEAM},
					.hpEV = 155,
					.attackEV = 100,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_HYDRO_PUMP, MOVE_POISON_BOMB, MOVE_SHADOW_BALL, MOVE_DESTINY_BOND},
					.hpEV = 100,
					.attackEV = 100,
					.defenseEV = 0,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHESTO_BERRY,
					.moves = {MOVE_HYDRO_PUMP, MOVE_MANA_BURST, MOVE_ATTRACT, MOVE_REST},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 155,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHESTO_BERRY,
					.moves = {MOVE_HYDRO_PUMP, MOVE_BLIZZARD, MOVE_DECISION, MOVE_REST},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_WATER_PULSE, MOVE_THUNDER_WAVE, MOVE_DECISION, MOVE_PROTECT},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 100,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHERI_BERRY,
					.moves = {MOVE_SCULPTURE, MOVE_MAGIC_POWDER, MOVE_JAMMING, MOVE_AGILITY},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_MIRROR_COAT, MOVE_JAMMING, MOVE_PROTECT, MOVE_TOXIC},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHESTO_BERRY,
					.moves = {MOVE_MANA_BURST, MOVE_BITE, MOVE_REFLECT, MOVE_REST},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 200,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_RECOVER, MOVE_MANA_BURST},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_EXPLOSION, MOVE_POISON_BOMB, MOVE_DESTINY_BOND, MOVE_THUNDERBOLT},
					.hpEV = 0,
					.attackEV = 200,
					.defenseEV = 155,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BENTO_BOX,
					.moves = {MOVE_PROTECT, MOVE_ZAP_CANNON, MOVE_TOXIC, MOVE_JAMMING},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 125,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_PORYGON2,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_THUNDER_WAVE, MOVE_ZAP_CANNON, MOVE_MANA_BURST, MOVE_RECOVER},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 125,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH, MOVE_MANA_BURST},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 155,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHOICE_RIBBON,
					.moves = {MOVE_THUNDERBOLT, MOVE_POISON_BOMB, MOVE_SHADOW_BALL, MOVE_BODY_SLAM},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 155,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_PETAYA_BERRY,
					.moves = {MOVE_THUNDERBOLT, MOVE_CONFUSE_RAY, MOVE_MANA_BURST, MOVE_EXPLOSION},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					...
					.moves = {MOVE_THUNDER_PUNCH, MOVE_MANA_BURST, MOVE_RECOVER, MOVE_REFLECT},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHOICE_RIBBON,
					.moves = {MOVE_THUNDERBOLT, MOVE_MAGIC_POWDER, MOVE_SCULPTURE, MOVE_ROCK_TOMB},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SHELL_BELL,
					.moves = {MOVE_THUNDERBOLT, MOVE_BLIZZARD, MOVE_SURF, MOVE_SCULPTURE},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 155,
					.speedEV = 0,
	...
	.trainers = {
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_RAIN_DANCE, MOVE_SURF, MOVE_GIGA_DRAIN, MOVE_POISON_BOMB},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 100,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SCOPE_LENS,
					.moves = {MOVE_THUNDER, MOVE_MANA_BURST, MOVE_CROSS_CHOP, MOVE_LIGHT_SCREEN},
					.hpEV = 0,
					.attackEV = 155,
					.defenseEV = 155,
					.speedEV = 100,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_PETAYA_BERRY,
					.moves = {MOVE_THUNDER, MOVE_SONIC_BOOM, MOVE_BINDING_VOICE, MOVE_REFLECT},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 155,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_PORYGON,
					.heldItem = ITEM_BENTO_BOX,
					.moves = {MOVE_THUNDER, MOVE_MANA_BURST, MOVE_BLIZZARD, MOVE_PROTECT},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
	...
	.trainers = {
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_ATTRACT, MOVE_REVERSAL, MOVE_THUNDERBOLT, MOVE_STEEL_FIST},
					.hpEV = 0,
					.attackEV = 155,
					.defenseEV = 100,
					.speedEV = 0,
	...
	.trainers = {
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHOICE_RIBBON,
					.moves = {MOVE_THUNDERBOLT, MOVE_FIRE_PUNCH, MOVE_MANA_BURST, MOVE_ICE_PUNCH},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LIECHI_BERRY,
					.moves = {MOVE_ZAP_CANNON, MOVE_HYPER_BEAM, MOVE_LOCK_ON, MOVE_JAMMING},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 200,
					.speedEV = 255,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_THUNDERBOLT, MOVE_KILLING_BITE, MOVE_HEAT_CLAW, MOVE_REVERSAL},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 100,
					.speedEV = 50,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHOICE_RIBBON,
					.moves = {MOVE_THUNDERBOLT, MOVE_POISON_BOMB, MOVE_FLAMETHROWER, MOVE_SHADOW_BALL},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BENTO_BOX,
					.moves = {MOVE_THUNDERBOLT, MOVE_POISON_BOMB, MOVE_GIGA_DRAIN, MOVE_CURSE},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 150,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_MANA_BURST, MOVE_GRUDGE, MOVE_CONFUSE_RAY, MOVE_DESTINY_BOND},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 150,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_POISON_BOMB, MOVE_CONFUSE_RAY, MOVE_GIGA_DRAIN, MOVE_TOXIC},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 200,
					.speedEV = 110,
	...
	.trainers = {
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_THUNDER_SHOCK, MOVE_BATTERY_CHARGE, MOVE_PROTECT, MOVE_RETURN},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_SING, MOVE_SWEET_KISS, MOVE_PRANK, MOVE_PROTECT},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_SCULPTURE, MOVE_POISON_BOMB, MOVE_FLATTER, MOVE_ATTRACT},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHOICE_RIBBON,
					.moves = {MOVE_SHOCK_WAVE, MOVE_SCULPTURE, MOVE_ICE_BEAM, MOVE_STEEL_FIST},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 155,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHOICE_RIBBON,
					.moves = {MOVE_THUNDERBOLT, MOVE_MANA_BURST, MOVE_WATER_PULSE, MOVE_FLAMETHROWER},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 155,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_CHOICE_RIBBON,
					.moves = {MOVE_THUNDERBOLT, MOVE_HYPER_BEAM, MOVE_MAGIC_POWDER, MOVE_SHADOW_BALL},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 150,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_THUNDERBOLT, MOVE_REVERSAL, MOVE_STEEL_FIST, MOVE_DOUBLE_EDGE},
					.hpEV = 0,
					.attackEV = 155,
					.defenseEV = 150,
					.speedEV = 100,
				...
				},
				{
					.species = SPECIES_GOLIATH,
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_THUNDERBOLT, MOVE_REST, MOVE_BODY_SLAM, MOVE_STEEL_FIST},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 150,
					.speedEV = 0,
