...
const u16 gBattleTextboxPaletteAlt[] = INCGFX_U16("graphics/battle_interface/textbox_alt.pal", ".gbapal");
...
const u16 gMessageBox_PalAlt[] = INCGFX_U16("graphics/text_window/message_box_alt.pal", ".gbapal");
