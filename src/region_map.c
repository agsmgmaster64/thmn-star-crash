...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_NEW_BARK_TOWN] = {MAP_GROUP(MAP_ONE_ISLAND), MAP_NUM(MAP_ONE_ISLAND), HEAL_LOCATION_ONE_ISLAND},
    [MAPSEC_CHERRYGROVE_CITY] = {MAP_GROUP(MAP_TWO_ISLAND), MAP_NUM(MAP_TWO_ISLAND), HEAL_LOCATION_TWO_ISLAND},
    [MAPSEC_VIOLET_CITY] = {MAP_GROUP(MAP_THREE_ISLAND), MAP_NUM(MAP_THREE_ISLAND), HEAL_LOCATION_THREE_ISLAND},
    [MAPSEC_AZALEA_TOWN] = {MAP_GROUP(MAP_FOUR_ISLAND), MAP_NUM(MAP_FOUR_ISLAND), HEAL_LOCATION_FOUR_ISLAND},
    [MAPSEC_GOLDENROD_CITY] = {MAP_GROUP(MAP_FIVE_ISLAND), MAP_NUM(MAP_FIVE_ISLAND), HEAL_LOCATION_FIVE_ISLAND},
    [MAPSEC_ECRUTEAK_CITY] = {MAP_GROUP(MAP_SEVEN_ISLAND), MAP_NUM(MAP_SEVEN_ISLAND), HEAL_LOCATION_SEVEN_ISLAND},
    [MAPSEC_OLIVINE_CITY] = {MAP_GROUP(MAP_SIX_ISLAND), MAP_NUM(MAP_SIX_ISLAND), HEAL_LOCATION_SIX_ISLAND},
    [MAPSEC_CIANWOOD_CITY] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_MAHOGANY_TOWN] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_BLACKTHORN_CITY] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_29] = {MAP_GROUP(MAP_ONE_ISLAND_KINDLE_ROAD), MAP_NUM(MAP_ONE_ISLAND_KINDLE_ROAD), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_30] = {MAP_GROUP(MAP_ONE_ISLAND_TREASURE_BEACH), MAP_NUM(MAP_ONE_ISLAND_TREASURE_BEACH), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_31] = {MAP_GROUP(MAP_TWO_ISLAND_CAPE_BRINK), MAP_NUM(MAP_TWO_ISLAND_CAPE_BRINK), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_32] = {MAP_GROUP(MAP_THREE_ISLAND_BOND_BRIDGE), MAP_NUM(MAP_THREE_ISLAND_BOND_BRIDGE), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_33] = {MAP_GROUP(MAP_THREE_ISLAND_PORT), MAP_NUM(MAP_THREE_ISLAND_PORT), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_34] = {MAP_GROUP(MAP_FIVE_ISLAND_RESORT_GORGEOUS), MAP_NUM(MAP_FIVE_ISLAND_RESORT_GORGEOUS), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_35] = {MAP_GROUP(MAP_FIVE_ISLAND_WATER_LABYRINTH), MAP_NUM(MAP_FIVE_ISLAND_WATER_LABYRINTH), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_36] = {MAP_GROUP(MAP_FIVE_ISLAND_MEADOW), MAP_NUM(MAP_FIVE_ISLAND_MEADOW), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_37] = {MAP_GROUP(MAP_FIVE_ISLAND_MEMORIAL_PILLAR), MAP_NUM(MAP_FIVE_ISLAND_MEMORIAL_PILLAR), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_38] = {MAP_GROUP(MAP_SIX_ISLAND_OUTCAST_ISLAND), MAP_NUM(MAP_SIX_ISLAND_OUTCAST_ISLAND), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_39] = {MAP_GROUP(MAP_SIX_ISLAND_GREEN_PATH), MAP_NUM(MAP_SIX_ISLAND_GREEN_PATH), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_40] = {MAP_GROUP(MAP_SIX_ISLAND_WATER_PATH), MAP_NUM(MAP_SIX_ISLAND_WATER_PATH), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_41] = {MAP_GROUP(MAP_SIX_ISLAND_RUIN_VALLEY), MAP_NUM(MAP_SIX_ISLAND_RUIN_VALLEY), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_42] = {MAP_GROUP(MAP_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE), MAP_NUM(MAP_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_43] = {MAP_GROUP(MAP_SEVEN_ISLAND_SEVAULT_CANYON), MAP_NUM(MAP_SEVEN_ISLAND_SEVAULT_CANYON), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_44] = {MAP_GROUP(MAP_SEVEN_ISLAND_TANOBY_RUINS), MAP_NUM(MAP_SEVEN_ISLAND_TANOBY_RUINS), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_45] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_46] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_LAKE_OF_RAGE] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_MT_SILVER_EXTERIOR] = {MAP_GROUP(MAP_BIRTH_ISLAND_EXTERIOR_FRLG), MAP_NUM(MAP_BIRTH_ISLAND_EXTERIOR_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_BELLCHIME_TRAIL] = {MAP_GROUP(MAP_SEVEN_ISLAND_TRAINER_TOWER), MAP_NUM(MAP_SEVEN_ISLAND_TRAINER_TOWER), HEAL_LOCATION_NONE},
    [MAPSEC_DARK_CAVE_SOUTH] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_SPROUT_TOWER] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_RUINS_OF_ALPH] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_UNION_CAVE] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_SLOWPOKE_WELL] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_ILEX_FOREST] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_GOLDENROD_TUNNEL] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_RADIO_TOWER] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_NATIONAL_PARK] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_BURNED_TOWER] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_BELL_TOWER] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_OLIVINE_LIGHTHOUSE] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_WHIRL_ISLANDS] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_MT_MORTAR] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_TEAM_ROCKET_HQ] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_ICE_PATH] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_DRAGONS_DEN] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_DARK_CAVE_NORTH] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
    [MAPSEC_MT_SILVER_CAVE] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
...
static const struct FlyLocation sFlyLocations[] =
{
    ...
    {
        .regionMap = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_NEW_BARK_TOWN,
        .flag = FLAG_WORLD_MAP_NEW_BARK_TOWN,
    },
    {
        .regionMap = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_CHERRYGROVE_CITY,
        .flag = FLAG_WORLD_MAP_CHERRYGROVE_CITY,
    },
    {
        .regionMap = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_VIOLET_CITY,
        .flag = FLAG_WORLD_MAP_VIOLET_CITY,
    },
    {
        .regionMap = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_AZALEA_TOWN,
        .flag = FLAG_WORLD_MAP_AZALEA_TOWN,
    },
    {
        .regionMap = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_GOLDENROD_CITY,
        .flag = FLAG_WORLD_MAP_GOLDENROD_CITY,
    },
    {
        .regionMap = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_ECRUTEAK_CITY,
        .flag = FLAG_WORLD_MAP_ECRUTEAK_CITY,
    },
    {
        .regionMap = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_OLIVINE_CITY,
        .flag = FLAG_WORLD_MAP_OLIVINE_CITY,
    },
    {
        .regionMap = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_CIANWOOD_CITY,
        .flag = FLAG_WORLD_MAP_CIANWOOD_CITY,
    },
    {
        .regionMap = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_MAHOGANY_TOWN,
        .flag = FLAG_WORLD_MAP_MAHOGANY_TOWN,
    },
    {
        .regionMap = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_BLACKTHORN_CITY,
        .flag = FLAG_WORLD_MAP_BLACKTHORN_CITY,
    },
    {
        .regionMap = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_LAKE_OF_RAGE,
        .flag = FLAG_WORLD_MAP_LAKE_OF_RAGE,
    },
    {
        .regionMap = REGION_MAP_KANTO,
