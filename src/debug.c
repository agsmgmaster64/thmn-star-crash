...
static const u16 sLocationFlags[] =
{
    ...
    FLAG_WORLD_MAP_NEW_BARK_TOWN,
    FLAG_WORLD_MAP_CHERRYGROVE_CITY,
    FLAG_WORLD_MAP_VIOLET_CITY,
    FLAG_WORLD_MAP_AZALEA_TOWN,
    FLAG_WORLD_MAP_GOLDENROD_CITY,
    FLAG_WORLD_MAP_ECRUTEAK_CITY,
    FLAG_WORLD_MAP_OLIVINE_CITY,
...
static u32 Debug_CheckToggleFlags(u8 id)
{
    ...
    case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_MATCH_CALL:
        result = FlagGet(FLAG_ADDED_MATCH_CALL_TO_POKENAV);
        break;
...
void DebugNative_GetAbilityNames(void)
{
    ...
    u32 cantRandomize = GetMonData(&gParties[B_TRAINER_PLAYER][gSpecialVar_0x8004], MON_DATA_CANT_RANDOMIZE_ABILITY);
