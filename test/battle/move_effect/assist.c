...
{
    GIVEN {
        PLAYER(SPECIES_CHIBI_YUUGI) { Moves(MOVE_ASSIST, MOVE_CELEBRATE, MOVE_METRONOME, MOVE_ME_FIRST); }
        PLAYER(SPECIES_CHIBI_YUUGI) { Moves(MOVE_ASSIST, MOVE_ENDURE, MOVE_DRAGON_TAIL, MOVE_SPOTLIGHT); }
