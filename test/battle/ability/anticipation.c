...
SINGLE_BATTLE_TEST("Anticipation considers Flying Press as an ordinary Fighting-type move")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_TANGELA, 1) == TYPE_NATURE);
...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Weather Ball")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_CHIBI_KEIKI, 0) == TYPE_NATURE);
        ASSUME(GetSpeciesType(SPECIES_CHIBI_KEIKI, 1) == TYPE_STEEL);
        PLAYER(SPECIES_CHIBI_KEIKI) { Ability(ABILITY_ANTICIPATION); Speed(2); }
...
SINGLE_BATTLE_TEST("Anticipation treats dynamic move types as their base type (Normal), Techno Blast")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_CHIBI_KEIKI, 0) == TYPE_NATURE);
        ASSUME(GetSpeciesType(SPECIES_CHIBI_KEIKI, 1) == TYPE_STEEL);
        PLAYER(SPECIES_CHIBI_KEIKI) { Ability(ABILITY_ANTICIPATION); }
...
SINGLE_BATTLE_TEST("Anticipation does not consider ate-abilities")
{
    GIVEN {
        ...
        ASSUME(GetSpeciesType(SPECIES_WORMADAM_PLANT, 1) == TYPE_NATURE);
