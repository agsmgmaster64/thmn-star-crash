...
#define FLAPPY_VAR_HIGH_SCORE           VAR_ROUTE113_STATE  // If this variable isn't set to 0, this tracks the high score of the Flappy Bird minigame
...
#define DERBY_VAR_RACER_1               VAR_UNUSED_0x40F8   // The following 6 variables hold the nickname ID for each racer in the derby
#define DERBY_VAR_RACER_2               VAR_UNUSED_0x40F9   // These variables only hold the ID itself, the actual nickname uses the species data as well
#define DERBY_VAR_RACER_3               VAR_UNUSED_0x40FA
#define DERBY_VAR_RACER_4               VAR_UNUSED_0x40FB
#define DERBY_VAR_RACER_5               VAR_UNUSED_0x40FC
#define DERBY_VAR_RACER_6               VAR_UNUSED_0x40FD
