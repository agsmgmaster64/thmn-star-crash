...
#define B_UPDATED_TOUHOUMON_MOVE_DATA TOUHOUMON_VERSION
#define B_UPDATED_TOUHOUMON_MOVE_TYPES TOUHOUMON_VERSION
#define B_TOUHOUMON_UPDATED_MOVE_FLAGS TOUHOUMON_VERSION
...
#define B_FLAG_FORCE_DOUBLE_WILD    FLAG_FORCED_WILD_DOUBLE     // If this flag is set, all land and surfing wild battles will be double battles.
...
#define B_FLAG_AI_VS_AI_BATTLE      FLAG_PLAYER_AI     // If this flag is set, the player's mons will be controlled by the ai next battles.
