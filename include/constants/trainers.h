...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_RENKO,
    TRAINER_PIC_FRONT_MARIBEL,
    ...
    TRAINER_PIC_FRONT_GIGI_MURIN,
    TRAINER_PIC_FRONT_DOISE,
    TRAINER_PIC_FRONT_MISCHIEVOUS_FAIRY,
    TRAINER_PIC_FRONT_SUNFLOWER_FAIRY,
    TRAINER_PIC_FRONT_RENKO_YOUNG,
    TRAINER_PIC_FRONT_MARIBEL_YOUNG,
    ...
    TRAINER_PIC_BACK_RENKO = TRAINER_PIC_FRONT_COUNT, // The player back pics are assumed to alternate according to the gender values (MALE/FEMALE)
    TRAINER_PIC_BACK_MARIBEL,
    ...
    TRAINER_PIC_BACK_RENKO_YOUNG,
    TRAINER_PIC_BACK_MARIBEL_YOUNG,
    TRAINER_PIC_BACK_GIGI,
    TRAINER_PIC_BACK_KRONII,
...
#define TRAINER_BACK_PIC_PLAYER_MALE (IS_FRLG ? TRAINER_PIC_BACK_RED : TRAINER_PIC_BACK_RENKO)
#define TRAINER_BACK_PIC_PLAYER_FEMALE (IS_FRLG ? TRAINER_PIC_BACK_LEAF : TRAINER_PIC_BACK_MARIBEL)
