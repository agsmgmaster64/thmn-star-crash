...
#define MOVE_RESULT_EXTREMELY_EFFECTIVE   (1 << 12)
#define MOVE_RESULT_MOSTLY_INEFFECTIVE    (1 << 13)
...
#define STARTING_STATUS_DEFINITIONS(F) \
    ...
    F(STARTING_STATUS_HOLY_TERRAIN,                   holyTerrain,                (u32, 1)) /* Holy Terrain (Permanent) */                 \
    F(STARTING_STATUS_HOLY_TERRAIN_TEMPORARY,         holyTerrainTemporary,       (u32, 1)) /* Holy Terrain Temporary (5 turns) */         \
    ...
    F(STARTING_STATUS_INVERSE_ROOM,                   inverseRoom,                (u32, 1)) /* Inverse Room (Permanent) */                 \
    F(STARTING_STATUS_INVERSE_ROOM_TEMPORARY,         inverseRoomTemporary,       (u32, 1)) /* Inverse Room Temporary (5 turns) */         \
