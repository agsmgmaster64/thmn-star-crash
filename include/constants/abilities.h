...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_DOUR_ECHO = 311,
    ABILITY_WALL_MASTER = 312,
    ABILITY_GRAND_THEORY = 313,
    ABILITY_PRIDE = 314,
    ABILITY_STASIS_GAZE = 315,
    ABILITY_PIERCING_DRILL = 316,
    ABILITY_DRAGONIZE = 317,
    ABILITY_EELEVATE = 318,
    ABILITY_314 = 319,
    ABILITY_MEGA_SOL = 320,
    ABILITY_FIRE_MANE = 321,
    ABILITY_317 = 322,
    ABILITY_SPICY_SPRAY = 323,
    ABILITY_EARTH_EATER = 324,
    ABILITY_AURA_GUARD = 325,
