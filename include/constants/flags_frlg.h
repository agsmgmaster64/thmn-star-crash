...
// Unused?
#define FLAG_POINT_BATTLE               0x4BD
#define FLAG_BANK_SAVE_MONEY               0x4BE
#define FLAG_SCRIPTED_LOSS               0x4BF
#define FLAG_NO_BAG_USE               0x4C0
#define FLAG_NO_CATCHING               0x4C1
#define FLAG_OVERRIDE_MUSIC               0x4C2
#define FLAG_COLLISIONS_DISABLED               0x4C3
#define FLAG_FORCED_WILD_DOUBLE               0x4C4
#define FLAG_SMART_WILD_AI               0x4C5
#define FLAG_PLAYER_AI               0x4C6
#define FLAG_INVERSE_BATTLE               0x4C7
#define FLAG_TRAINERS_BLIND               0x4C8
#define FLAG_FORCED_SHINY               0x4C9
#define FLAG_SHINY_LOCK               0x4CA
...
#define FLAG_EXP_SHARE_MODERN               0x4D2
#define FLAG_NO_RUNNING               0x4D3
#define FLAG_ORAS_DOWSE               0x4D4
#define FLAG_USE_PYRAMID_BAG               0x4D5
#define FLAG_DEXNAV_SEARCH               0x4D6
#define FLAG_SYS_DEXNAV_GET               0x4D7
#define FLAG_DEXNAV_DETECTOR_MODE               0x4D8
#define FLAG_SYS_QUEST_MENU_GET               0x4D9
#define FLAG_DERBY_RESET               0x4DA
#define FLAG_DERBY_NICKNAME               0x4DB
#define FLAG_BATTLE_MENU_COMING_FROM_SUMMARY_SCREEN               0x4DC
...
#define FLAG_WORLD_MAP_ROUTE4_POKEMON_CENTER_1F                     (SYS_FLAGS + 0x9B)
#define FLAG_WORLD_MAP_ROUTE10_POKEMON_CENTER_1F                    (SYS_FLAGS + 0x9C)
#define FLAG_WORLD_MAP_VIRIDIAN_FOREST                              (SYS_FLAGS + 0x9D)
#define FLAG_WORLD_MAP_MT_MOON_1F                                   (SYS_FLAGS + 0x9E)
#define FLAG_WORLD_MAP_SSANNE_EXTERIOR                              (SYS_FLAGS + 0x9F)
#define FLAG_WORLD_MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL          (SYS_FLAGS + 0xA0)
#define FLAG_WORLD_MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL            (SYS_FLAGS + 0xA1)
#define FLAG_WORLD_MAP_DIGLETTS_CAVE_B1F                            (SYS_FLAGS + 0xA2)
#define FLAG_WORLD_MAP_VICTORY_ROAD_1F                              (SYS_FLAGS + 0xA3)
#define FLAG_WORLD_MAP_ROCKET_HIDEOUT_B1F                           (SYS_FLAGS + 0xA4)
#define FLAG_WORLD_MAP_SILPH_CO_1F                                  (SYS_FLAGS + 0xA5)
#define FLAG_WORLD_MAP_POKEMON_MANSION_1F                           (SYS_FLAGS + 0xA6)
#define FLAG_WORLD_MAP_SAFARI_ZONE_CENTER                           (SYS_FLAGS + 0xA7)
#define FLAG_WORLD_MAP_POKEMON_LEAGUE_LORELEIS_ROOM                 (SYS_FLAGS + 0xA8)
#define FLAG_WORLD_MAP_ROCK_TUNNEL_1F                               (SYS_FLAGS + 0xA9)
#define FLAG_WORLD_MAP_SEAFOAM_ISLANDS_1F                           (SYS_FLAGS + 0xAA)
#define FLAG_WORLD_MAP_POKEMON_TOWER_1F                             (SYS_FLAGS + 0xAB)
#define FLAG_WORLD_MAP_CERULEAN_CAVE_1F                             (SYS_FLAGS + 0xAC)
#define FLAG_WORLD_MAP_POWER_PLANT                                  (SYS_FLAGS + 0xAD)
#define FLAG_WORLD_MAP_MT_SILVER_CAVE                               (SYS_FLAGS + 0xAE)
#define FLAG_WORLD_MAP_NEW_BARK_TOWN                                (SYS_FLAGS + 0xAF)
#define FLAG_WORLD_MAP_CHERRYGROVE_CITY                             (SYS_FLAGS + 0xB0)
#define FLAG_WORLD_MAP_VIOLET_CITY                                  (SYS_FLAGS + 0xB1)
#define FLAG_WORLD_MAP_AZALEA_TOWN                                  (SYS_FLAGS + 0xB2)
#define FLAG_WORLD_MAP_GOLDENROD_CITY                               (SYS_FLAGS + 0xB3)
#define FLAG_WORLD_MAP_ECRUTEAK_CITY                                (SYS_FLAGS + 0xB4)
#define FLAG_WORLD_MAP_OLIVINE_CITY                                 (SYS_FLAGS + 0xB5)
#define FLAG_WORLD_MAP_CIANWOOD_CITY                                (SYS_FLAGS + 0xB6)
#define FLAG_WORLD_MAP_MAHOGANY_TOWN                                (SYS_FLAGS + 0xB7)
#define FLAG_WORLD_MAP_BLACKTHORN_CITY                              (SYS_FLAGS + 0xB8)
#define FLAG_WORLD_MAP_LAKE_OF_RAGE                                 (SYS_FLAGS + 0xB9)
#define FLAG_WORLD_MAP_MT_SILVER_EXTERIOR                           (SYS_FLAGS + 0xBA)
#define FLAG_WORLD_MAP_DARK_CAVE                                    (SYS_FLAGS + 0xBB)
#define FLAG_WORLD_MAP_SPROUT_TOWER                                 (SYS_FLAGS + 0xBC)
#define FLAG_WORLD_MAP_RUINS_OF_ALPH                                (SYS_FLAGS + 0xBD)
#define FLAG_WORLD_MAP_UNION_CAVE                                   (SYS_FLAGS + 0xBE)
#define FLAG_WORLD_MAP_SLOWPOKE_WELL                                (SYS_FLAGS + 0xBF)
#define FLAG_WORLD_MAP_ILEX_FOREST                                  (SYS_FLAGS + 0xC0)
#define FLAG_WORLD_MAP_NATIONAL_PARK                                (SYS_FLAGS + 0xC1)
#define FLAG_WORLD_MAP_BURNT_TOWER                                  (SYS_FLAGS + 0xC2)
#define FLAG_WORLD_MAP_BELL_TOWER                                   (SYS_FLAGS + 0xC3)
#define FLAG_WORLD_MAP_OLIVINE_LIGHTHOUSE                           (SYS_FLAGS + 0xC4)
#define FLAG_WORLD_MAP_WHIRL_ISLANDS                                (SYS_FLAGS + 0xC5)
#define FLAG_WORLD_MAP_MT_MORTAR                                    (SYS_FLAGS + 0xC6)
#define FLAG_WORLD_MAP_TEAM_ROCKET_HQ                               (SYS_FLAGS + 0xC7)
#define FLAG_WORLD_MAP_ICE_PATH                                     (SYS_FLAGS + 0xC8)
#define FLAG_WORLD_MAP_DRAGONS_DEN                                  (SYS_FLAGS + 0xC9)
