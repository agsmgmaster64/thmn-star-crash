...
#define AI_FLAG_SMART_TRAINER         (AI_FLAG_BASIC_TRAINER | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_PP_STALL_PREVENTION | AI_FLAG_SMART_TERA)
#define AI_FLAG_VERY_SMART_TRAINER    (AI_FLAG_SMART_TRAINER | AI_FLAG_OMNISCIENT | AI_FLAG_RANDOMIZE_SWITCHIN)
