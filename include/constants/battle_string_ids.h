...
enum StringID
{
    ...
    STRINGID_TOOMUCHHONEY,
    STRINGID_HONEYCHIPHEAL,
    STRINGID_HONEYCHIPENDS,
    STRINGID_HARVESTHONEY,
    ...
    STRINGID_BAGISFULL,
    STRINGID_PKMNFROSTBITBY,
    STRINGID_FELTBETTERWITHABILITY,
    STRINGID_EFFFELTBETTERWITHABILITY,
    STRINGID_HOLYSURROUNDSBATTLEFIELD,
    STRINGID_TERRAINBECOMESHOLY,
    STRINGID_HOLYTERRAINENDS,
    STRINGID_HOLYTERRAINPREVENTS,
    STRINGID_NUZLOCKECAPTUREBLOCKED,
    STRINGID_SAMESPECIESCAPTUREBLOCKED,
    STRINGID_LUCIDDREAMINGENTERS,
    STRINGID_GIVINGHEARTCAMETRUE,
    STRINGID_GIVINGHEARTLASTWISH,
    STRINGID_SWAPSTYPEEFFECTIVENESS,
    STRINGID_INVERSEROOMENDS,
    STRINGID_CHARGEDVICIOUSAURA,
    STRINGID_PLAYERGOTPOINTS,
...
{
    B_MSG_SET_TRICK_ROOM = B_MSG_TERRAIN_COUNT,
