...
#define BXPY_TYPE_FRAME_NORMAL                    (TYPE_ILLUSION           * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_FIGHTING                  (TYPE_DREAM              * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_FLYING                    (TYPE_FLYING             * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_POISON                    (TYPE_MIASMA             * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_GROUND                    (TYPE_EARTH              * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_ROCK                      (TYPE_BEAST              * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_BUG                       (TYPE_HEART              * BXPY_TYPE_FRAME_SIZE)
...
#define BXPY_TYPE_FRAME_GRASS                     (TYPE_NATURE             * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_ELECTRIC                  (TYPE_ELECTRIC           * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_PSYCHIC                   (TYPE_REASON             * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_ICE                       (TYPE_ICE                * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_DRAGON                    (TYPE_FAITH              * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_DARK                      (TYPE_DARK               * BXPY_TYPE_FRAME_SIZE)
#define BXPY_TYPE_FRAME_FAIRY                     (TYPE_COSMIC             * BXPY_TYPE_FRAME_SIZE)
