...
#define OPTIONS_R_BUTTON_MODE_NONE 0
#define OPTIONS_R_BUTTON_MODE_DEXNAV_SEARCH 1
#define OPTIONS_R_BUTTON_MODE_BIKE_SWITCH 2
#define OPTIONS_R_BUTTON_MODE_REGISTER 3

#define OPTIONS_L_BUTTON_MODE_NONE 0
#define OPTIONS_L_BUTTON_MODE_DEBUG_MENU 1
#define OPTIONS_L_BUTTON_MODE_AUTO_RUN 2
#define OPTIONS_L_BUTTON_MODE_REGISTER 3
#define OPTIONS_L_BUTTON_MODE_L_EQUALS_A 4

#define PLAYLIST_SET_STYLE_DEFAULT 0
#define PLAYLIST_SET_STYLE_REGULAR 1
#define PLAYLIST_SET_STYLE_ZGS 2
#define PLAYLIST_SET_STYLE_ALTERNATE 3
