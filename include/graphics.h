...
extern const u32 gBallGfx_Foul[];
extern const u16 gBallPal_Foul[];
extern const u32 gBallGfx_Bomb[];
extern const u16 gBallPal_Bomb[];
...
extern const u32 gBallGfx_PokeHisui[];
extern const u16 gBallPal_PokeHisui[];
extern const u32 gBallGfx_GreatHisui[];
extern const u16 gBallPal_GreatHisui[];
extern const u32 gBallGfx_UltraHisui[];
extern const u16 gBallPal_UltraHisui[];
...
extern const u32 gItemIcon_FoulOrb[];
extern const u16 gItemIconPalette_FoulOrb[];
extern const u32 gItemIcon_BombOrb[];
extern const u16 gItemIconPalette_BombOrb[];
...
extern const u32 gItemIcon_PokeBallHisui[];
extern const u16 gItemIconPalette_PokeBallHisui[];
extern const u32 gItemIcon_GreatBallHisui[];
extern const u16 gItemIconPalette_GreatBallHisui[];
// Medicine
...
extern const u32 gItemIcon_GeyserWater[];
extern const u16 gItemIconPalette_GeyserWater[];
extern const u32 gItemIcon_BeerBottle[];
extern const u16 gItemIconPalette_BeerBottle[];
extern const u32 gItemIcon_UnagiLunch[];
extern const u16 gItemIconPalette_UnagiLunch[];
extern const u32 gItemIcon_SakeGourd[];
extern const u16 gItemIconPalette_SakeGourd[];
extern const u32 gItemIcon_LumioseGalette[];
extern const u16 gItemIconPalette_LumioseGalette[];
extern const u32 gItemIcon_HeavenPeach[];
extern const u16 gItemIconPalette_HeavenPeach[];
...
extern const u32 gItemIcon_UFO[];
extern const u16 gItemIconPalette_GreenUFO[];
extern const u16 gItemIconPalette_RedUFO[];
extern const u16 gItemIconPalette_BlueUFO[];
...
// Evolution Items
extern const u32 gItemIcon_EvoHeart[];
extern const u16 gItemIconPalette_PowerHeart[];
extern const u16 gItemIconPalette_GuardHeart[];
extern const u16 gItemIconPalette_SwiftHeart[];
extern const u16 gItemIconPalette_TechHeart[];
extern const u16 gItemIconPalette_HelperHeart[];
extern const u16 gItemIconPalette_JustHeart[];
extern const u16 gItemIconPalette_ChromeHeart[];
extern const u16 gItemIconPalette_NeutralHeart[];
...
extern const u32 gItemIcon_IcyBall[];
extern const u16 gItemIconPalette_IcyBall[];
extern const u32 gItemIcon_Bloomers[];
extern const u16 gItemIconPalette_Bloomers[];
extern const u32 gItemIcon_DarkRibbon[];
extern const u16 gItemIconPalette_DarkRibbon[];
extern const u32 gItemIcon_BigCloud[];
extern const u16 gItemIconPalette_BigCloud[];
extern const u32 gItemIcon_AssistBall[];
...
extern const u32 gItemIcon_DoubleSoul[];
extern const u16 gItemIconPalette_DoubleSoul[];
...
extern const u32 gItemIcon_BridalGown[];
extern const u16 gItemIconPalette_BridalGown[];
extern const u32 gItemIcon_GothicDress[];
extern const u16 gItemIconPalette_GothicDress[];
extern const u32 gItemIcon_Swimsuit[];
extern const u16 gItemIconPalette_Swimsuit[];
extern const u32 gItemIcon_NinjaSuit[];
extern const u16 gItemIconPalette_NinjaSuit[];
extern const u32 gItemIcon_Camouflage[];
extern const u16 gItemIconPalette_Camouflage[];
extern const u32 gItemIcon_ThickFur[];
extern const u16 gItemIconPalette_ThickFur[];
extern const u32 gItemIcon_ChinaDress[];
extern const u16 gItemIconPalette_ChinaDress[];
extern const u32 gItemIcon_NurseOutfit[];
extern const u16 gItemIconPalette_NurseOutfit[];
extern const u32 gItemIcon_GymSuit[];
extern const u16 gItemIconPalette_GymSuit[];
extern const u32 gItemIcon_Stewardess[];
extern const u16 gItemIconPalette_Stewardess[];
extern const u32 gItemIcon_WitchsRobe[];
extern const u16 gItemIconPalette_WitchsRobe[];
extern const u32 gItemIcon_Blazer[];
extern const u16 gItemIconPalette_Blazer[];
extern const u32 gItemIcon_BunnySuit[];
extern const u16 gItemIconPalette_BunnySuit[];
extern const u32 gItemIcon_BurialDress[];
extern const u16 gItemIconPalette_BurialDress[];
extern const u32 gItemIcon_Priestess[];
extern const u16 gItemIconPalette_Priestess[];
...
extern const u16 gItemIconPalette_MaidUniform[];
...
extern const u16 gItemIconPalette_LoveLetter[];
extern const u32 gItemIcon_BeastClaw[];
extern const u16 gItemIconPalette_BeastClaw[];
extern const u32 gItemIcon_QuestionArcs[];
extern const u16 gItemIconPalette_QuestionArcs[];
extern const u32 gItemIcon_SharpSword[];
extern const u16 gItemIconPalette_SharpSword[];
extern const u32 gItemIcon_DubiousTome[];
extern const u16 gItemIconPalette_DubiousTome[];
// Choice Items
...
extern const u32 gItemIcon_DonationBox[];
extern const u16 gItemIconPalette_DonationBox[];
...
extern const u32 gItemIcon_StribBerry[];
extern const u16 gItemIconPalette_StribBerry[];
extern const u32 gItemIcon_TurlanBerry[];
extern const u16 gItemIconPalette_TurlanBerry[];
extern const u32 gItemIcon_NutpeaBerry[];
extern const u16 gItemIconPalette_NutpeaBerry[];
extern const u32 gItemIcon_IonnoBerry[];
extern const u16 gItemIconPalette_IonnoBerry[];
extern const u32 gItemIcon_KuoBerry[];
extern const u16 gItemIconPalette_KuoBerry[];
extern const u32 gItemIcon_YagoBerry[];
extern const u16 gItemIconPalette_YagoBerry[];
extern const u32 gItemIcon_TougaBerry[];
extern const u16 gItemIconPalette_TougaBerry[];
extern const u32 gItemIcon_GarligBerry[];
extern const u16 gItemIconPalette_GarligBerry[];
extern const u32 gItemIcon_TopoBerry[];
...
extern const u16 gItemIconPalette_IllusionTMHM[];
extern const u16 gItemIconPalette_WindTMHM[];
extern const u16 gItemIconPalette_NatureTMHM[];
extern const u16 gItemIconPalette_DreamTMHM[];
extern const u16 gItemIconPalette_MiasmaTMHM[];
extern const u16 gItemIconPalette_EarthTMHM[];
extern const u16 gItemIconPalette_ReasonTMHM[];
extern const u16 gItemIconPalette_HeartTMHM[];
extern const u16 gItemIconPalette_BeastTMHM[];
extern const u16 gItemIconPalette_FaithTMHM[];
extern const u16 gItemIconPalette_CosmicTMHM[];
// Charms
...
extern const u32 gShopMenuBalance_Gfx[];
...
extern const u16 gBattleAnimSpritePal_BurnPowder[];
extern const u16 gBattleAnimSpritePal_PoisonPowder[];
