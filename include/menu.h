...
#define MENU_INFO_ICON_CATEGORY  (NUMBER_OF_MON_TYPES + 6)
#define MENU_INFO_ICON_PHYSICAL  (NUMBER_OF_MON_TYPES + 7)
#define MENU_INFO_ICON_SPECIAL   (NUMBER_OF_MON_TYPES + 8)
#define MENU_INFO_ICON_STATUS    (NUMBER_OF_MON_TYPES + 9)
#define MENU_INFO_ICON_BALL_RED  (NUMBER_OF_MON_TYPES + 10)
#define MENU_INFO_ICON_BALL_BLUE (NUMBER_OF_MON_TYPES + 11)
