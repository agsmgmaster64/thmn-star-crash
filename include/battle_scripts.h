...
extern const u8 BattleScript_DoiseBattleWon[];
...
extern const u8 BattleScript_MoveUsedLucidDreaming[];
...
extern const u8 BattleScript_HoneyChipHeal[];
extern const u8 BattleScript_HoneyChipEnds[];
...
extern const u8 BattleScript_HoneyGatherActivatesEntry[];
...
extern const u8 BattleScript_HolySurgeActivates[];
...
extern const u8 BattleScript_HolyTerrainPrevents[];
...
extern const u8 BattleScript_DourEchoActivatesAtk[];
extern const u8 BattleScript_DourEchoActivatesSpAtk[];
...
extern const u8 BattleScript_DeterminatorActivates[];
...
extern const u8 BattleScript_GivingHeartActivates[];
extern const u8 BattleScript_GivingHeartStore[];
...
extern const u8 BattleScript_AlreadyFrostbit[];
...
extern const u8 BattleScript_EffectHoneyboiled[];
...
extern const u8 BattleScript_EffectHolyTerrain[];
...
extern const u8 BattleScript_MonBallDodge[];
