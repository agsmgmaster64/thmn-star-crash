...
extern const u8 gText_Var1sVar2And[];
extern const u8 gText_Var1sVar2WereSwapped[];
...
extern const u8 gText_Gura[];
extern const u8 gText_Ina[];
extern const u8 gText_Kiara[];
extern const u8 gText_Calli[];
extern const u8 gText_Kronii[];
extern const u8 gText_Baelz[];
extern const u8 gText_Mumei[];
extern const u8 gText_Fauna[];
extern const u8 gText_Sana[];
extern const u8 gText_IRyS[];
extern const u8 gText_Shiori[];
extern const u8 gText_Bijou[];
extern const u8 gText_Nerissa[];
extern const u8 gText_Fuwawa[];
extern const u8 gText_Mococo[];
extern const u8 gText_FuwaMoco[];
extern const u8 gText_Gigi[];
extern const u8 gText_Cecilia[];
extern const u8 gText_Elizabeth[];
extern const u8 gText_Raora[];
extern const u8 gText_Maddie[];
extern const u8 gText_Cyan[];
...
extern const u8 gText_MoveRelearnerContinue[];
...
extern const u8 gText_YouDontHaveCoins[];
extern const u8 gText_Var1CertainlyHowMany2[];
extern const u8 gText_Var1CertainlyHowMany[];
extern const u8 gText_Var1IsItThatllBeVar2[];
extern const u8 gText_YouWantedVar1ThatllBeVar2[];
extern const u8 gText_YouWantedVar1ThatllBeVar2_Coins[];
extern const u8 gText_YouWantedVar1OutfitThatllBeVar2[];
extern const u8 gText_InBagVar1[];
extern const u8 gText_Var1AndYouWantedVar2[];
extern const u8 gText_Var1AndYouWantedVar2_Coins[];
...
extern const u8 gText_DexSearchSourceTouhou1[];
extern const u8 gText_DexSearchSourceTouhou2[];
extern const u8 gText_DexSearchSourceTouhou3[];
extern const u8 gText_DexSearchSourceTouhou4[];
extern const u8 gText_DexSearchSourceTouhou5[];
extern const u8 gText_DexSearchSourceTouhou6[];
extern const u8 gText_DexSearchSourceTouhou7[];
extern const u8 gText_DexSearchSourceTouhou8[];
extern const u8 gText_DexSearchSourceTouhou9[];
extern const u8 gText_DexSearchSourceTouhou10[];
extern const u8 gText_DexSearchSourceTouhou11[];
extern const u8 gText_DexSearchSourceTouhou12[];
extern const u8 gText_DexSearchSourceTouhou13[];
extern const u8 gText_DexSearchSourceTouhou14[];
extern const u8 gText_DexSearchSourceTouhou15[];
extern const u8 gText_DexSearchSourceTouhou16[];
extern const u8 gText_DexSearchSourceTouhou17[];
extern const u8 gText_DexSearchSourceTouhou18[];
extern const u8 gText_DexSearchSourceTouhou19[];
extern const u8 gText_DexSearchSourceTouhouSpinoff[];
extern const u8 gText_DexSearchSourceTouhouPrint[];
extern const u8 gText_DexSearchSourceVTubers[];
...
extern const u8 gText_DexSearchSourceMario[];
extern const u8 gText_DexSearchSourceMisc[];
extern const u8 gText_DexHRTPDescription[];
extern const u8 gText_DexSOEWDescription[];
extern const u8 gText_DexPODDDescription[];
extern const u8 gText_DexLLSDescription[];
extern const u8 gText_DexMSDescription[];
extern const u8 gText_DexEOSDDescription[];
extern const u8 gText_DexPCBDescription[];
extern const u8 gText_DexINDescription[];
extern const u8 gText_DexPOFVDescription[];
extern const u8 gText_DexMOFDescription[];
extern const u8 gText_DexSADescription[];
extern const u8 gText_DexUFODescription[];
extern const u8 gText_DexTDDescription[];
extern const u8 gText_DexDDCDescription[];
extern const u8 gText_DexLOLKDescription[];
extern const u8 gText_DexHSIFSDescription[];
extern const u8 gText_DexWBAWCDescription[];
extern const u8 gText_DexUMDescription[];
extern const u8 gText_DexUDOALGDescription[];
extern const u8 gText_DexSpinoffDescription[];
extern const u8 gText_DexPrintWDescription[];
extern const u8 gText_DexOtherDescription[];
